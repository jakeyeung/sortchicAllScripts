...
mark="H3K4me1"
inmain="t2:/hpc/hub_oudenaarden/jyeung/data/scChiC/mara_analysis/$mark/mara_output/hiddenDomains_cellmin_100-cellmax_500000-binarize_TRUE-BM_$mark.filt_0.99.center_TRUE-hiddenDomains_motevo_merged.closest.long.scale_0.center_0.byrow_0.bugfix.filt.10000-"
...
rsync -avrL --partial --copy-links $inmain $outmain
