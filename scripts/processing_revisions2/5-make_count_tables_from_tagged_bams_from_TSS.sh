...
outbase="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/allmerged/count_mats_TSS"
...
for jmark in $jmarks; do 
  ...
  for binsize in $binsizes; do
	  ...
	  # bedfile="MmRefseqTss.chromorenamed.50000.again.nochromo.bed"
