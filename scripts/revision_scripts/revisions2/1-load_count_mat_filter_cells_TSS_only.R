...
matmain <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/allmerged/count_mats_TSS/counts_tables_10000"
...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/allmerged/LDA_count_mats_inputs_TSS_only"
dir.create(outdir)
for (jmark in jmarks){
  print(jmark)
  outftmp <- file.path(outdir, paste0("count_mat_allmerged_for_LDA_TSS_only.", jmark, ".", Sys.Date(), ".rds"))
