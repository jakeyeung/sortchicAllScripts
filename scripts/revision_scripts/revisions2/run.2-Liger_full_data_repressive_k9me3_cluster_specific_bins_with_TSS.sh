...
rs="/nfs/scistore12/hpcgrp/jyeung/projects/scchic/scripts/revision_scripts/revisions2/2-Liger_full_data_repressive_k9me3_cluster_specific_bins_keeptop_bymark_with_TSS.R"
...
outmain="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/integration_data/liger_outputs/k9me3_with_TSS"
...
for jfactor in $jfactors; do
  outdir="${outmain}/with_k9me3_cluster_specific_bins_keeptop_${keeptop}_bymark_factor_${jfactor}_with_TSS"
