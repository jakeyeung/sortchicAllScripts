...
outdir <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/allmerged/LDA_count_mats_inputs_k9_cluster_specific_bins_keeptop_", keeptop)
dir.create(outdir)
for (jmark in jmarks){
  print(jmark)
  outftmp <- file.path(outdir, paste0("count_mat_allmerged_for_LDA_k9_cluster_specific_bins_keeptop_", keeptop, ".", jmark, ".", Sys.Date(), ".rds"))
