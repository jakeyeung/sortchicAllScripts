...
# File: ~/projects/scchic/scripts/revision_scripts/revisions2/3-Liger_downstreams_k9me3.R
# 
...
indir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/integration_data/liger_outputs/k9me3/with_k9me3_cluster_specific_bins_keeptop_500_bymark_factor_-1"

outpdf <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/integration_data/liger_outputs/plots/", jmarkref, "_factor_", jfactor, ".", Sys.Date(), ".pdf")
