...
outpdf <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/batch_effect_corrections/plots_pca_output_mat_adj_full_pca.k27me3.", Sys.Date(), ".pdf")
...
logodds.pca <- readRDS("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/batch_effect_corrections/pca_output_mat_adj.k27me3.2022-04-20.rds")
...
fwrite(dat.umap.annot, file = paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/batch_effect_corrections/dat_umap_annot_batch_corrected.k27me3.", Sys.Date(), ".txt"), sep = "\t")
