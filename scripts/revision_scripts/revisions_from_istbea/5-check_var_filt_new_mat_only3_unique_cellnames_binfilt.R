...
# File: ~/projects/scchic/scripts/scripts_analysis/revisions_from_istbea/5-check_var_filt_new_mat_only3_unique_cellnames_binfilt.R
# 
...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/count_mats_varfilt3"
dir.create(outdir)
