# Jake Yeung
# Date of Creation: 2022-01-30
# File: ~/projects/scchic/scripts/scripts_analysis/revisions_from_istbea/3-check_celltype_labeling_varfilt.R
# 
...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/celltyping/varfilt"
dir.create(outdir)

for (jmark in jmarksnew){
  print(jmark)
  
  outpdf <- file.path(outdir, paste0("celltyping_", jmark, ".", jsuffix, ".", Sys.Date(), ".pdf"))
  outmeta <- file.path(outdir, paste0("metadata_celltyping_", jmark, ".", jsuffix, ".", Sys.Date(), ".txt"))
  ...
  # indir <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/LDA_outputs_bugfixed", jsuffix)
  # indir <- 
  ...
  # inf <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/LDA_outputs_varfilt/ldaAnalysis_fripfilt_varfilt/lda_outputs.count_mat_var_filt_", jsuffix, ".out_dynamic_bins_new_only.varcutoff.", jmark, ".2022-01-28/ldaOut.count_mat_var_filt_", jsuffix, ".out_dynamic_bins_new_only.varcutoff.", jmark, ".2022-01-28.Robj")
  # assertthat::assert_that(file.exists(inf))
  
  inf.meta.old <- file.path(indir.meta, paste0("metadata_batch_corrected.arranged_by_lineage.", jmarkold, ".2021-01-02.txt"))
  inf.meta.new <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/metadata/varfilt/metadata_plate_experi_batch.varfilt.", jsuffix, ".", jmark, ".2022-01-30.txt")
