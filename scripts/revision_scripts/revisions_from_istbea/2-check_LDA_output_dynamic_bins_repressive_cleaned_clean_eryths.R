...
# File: ~/projects/scchic/scripts/revision_scripts/revisions_from_istbea/2-check_LDA_output_dynamic_bins_repressive_cleaned_clean_eryths.R
# 
...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/metadata/repressive_cleaned_clean_eryths"
dir.create(outdir)
