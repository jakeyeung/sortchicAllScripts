...
# File: ~/projects/scchic/scripts/scripts_analysis/revisions_from_istbea/5-check_var_filt_new_mat_only3.R
# 
...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/count_mats_varfilt_again_binfilt"
dir.create(outdir)
...
for (jmark in jmarksnew){
  ...
  cells.keep.new <- subset(dat.meta.new.var.cutoff, is.good)$cell
