...
# jmark <- "k27me3"
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/glmpca_outputs/k27me3_cleaned"
dir.create(outdir)
# jmarks <- c("k4me3"); names(jmarks) <- jmarks
jmark <- "k27me3"

jsuffixs <- c("merged_with_old", "new_only"); names(jsuffixs) <- jsuffixs
