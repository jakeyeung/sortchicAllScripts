...
# File: ~/projects/scchic/scripts/scripts_analysis/revisions_from_istbea/10-fit_pseudotime_glm_parallel_k27me3.R
# description
rm(list=ls())
...
inf.traj.lst <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/trajs/trajs_outputs.", jmark, ".2022-02-06.rds")
