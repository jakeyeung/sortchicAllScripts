...
# File: ~/projects/scchic/scripts/revision_scripts/revisions_from_istbea/4-glmpca_downstream_k4me3_cleaned.R
# 
...
# jmark <- "k27me3"
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/glmpca_outputs/k4me3_cleaned"
dir.create(outdir)
...
for (jmark in jmarks){
  ...
  # inf.glmpca <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/glmpca_outputs/clean_again_k4me3_k27me3/glmpca.", jmark, ".bincutoff_0.binskeep_0.platename_batch.szname_none.niter_1000.newcells.RData")
  load(inf.glmpca, v=T)
