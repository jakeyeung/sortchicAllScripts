...
for (jmark in jmarksnew){
  ...
  inf.meta.new <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/metadata/repressive_cleaned_check_eryths/metadata_plate_experi_batch.cleaned_check_eryths.", jsuffix, ".", jmark, ".2022-04-06.txt")
