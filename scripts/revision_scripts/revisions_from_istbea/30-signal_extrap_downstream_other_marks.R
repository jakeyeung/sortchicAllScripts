...
print("PCA... done")
saveRDS(pca.out, file = paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/gam_fits/downstream_pca_out.", jmark, ".", Sys.Date(), ".rds"))
