...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/ptimefits_plots_top_hits_TSS_markergenes_colcode_newonly"
dir.create(outdir)
...
for (jmark in jmarks){
  ...
  for (jctype in ctypes.names){
    ...
    cells.keep <- subset(dat.meta.LL, batch == "New")$cell
