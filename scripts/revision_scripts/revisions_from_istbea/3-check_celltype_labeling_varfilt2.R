...
jmarksnew <- c("k4me3", "k27me3", "k9me3"); names(jmarksnew) <- jmarksnew
jmarksold <- c("H3K4me3", "H3K27me3", "H3K9me3"); names(jmarksold) <- jmarksnew

outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/celltyping/varfilt_again"
dir.create(outdir)
...
for (jmark in jmarksnew){
  ...
  inf.meta.new <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/metadata/varfilt_again/metadata_plate_experi_batch.varfilt.", jsuffix, ".", jmark, ".2022-02-14.txt")
