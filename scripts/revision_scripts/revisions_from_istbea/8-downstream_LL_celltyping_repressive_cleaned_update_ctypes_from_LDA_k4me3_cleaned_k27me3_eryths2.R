...
# File: ~/projects/scchic/scripts/revision_scripts/revisions_from_istbea/8-downstream_LL_celltyping_repressive_cleaned_update_ctypes_from_LDA_k4me3_cleaned_k27me3_eryths2.R
# 
...
for (jmark in jmarks){
  ...
  inf <- file.path(indir, paste0("LLmat_by_batch_dynamicbins_", jmark, ".2022-04-16.rds"))
