...
LL.all.lst <- lapply(jmarks, function(jmark){
  ...
  # ctypes.to.annotate <- c("Bcells", "Eryths", "GMP", "DCs", "Granulocytes", "HSCs", "LT", "MEP", "MPPs", "pDCs", "ST", "Monocytes", "Tcells", "NKs", "")
  ctypes.to.annotate <- c("Bcells", "CMP", "DCs", "Eryths", "GMP", "Granulocytes", "HSCs", "LT", "MEP", "Monocytes", "MPPs", "NKs", "pDCs", "ST", "Tcells")
