...
# File: ~/projects/scchic/scripts/scripts_analysis/revisions_from_istbea/5-check_batch_effects_k9me3.R
# 
...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/count_mats_varfilt2"
