...
# File: ~/projects/scchic/scripts/scripts_analysis/revisions_from_istbea/3-check_celltype_labeling_repressive_cleaned.R
# 
...
for (jmark in jmarksnew){
  ...
  inf.meta.new <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/metadata/repressive_cleaned/metadata_plate_experi_batch.cleaned.", jsuffix, ".", jmark, ".2022-02-17.txt")
