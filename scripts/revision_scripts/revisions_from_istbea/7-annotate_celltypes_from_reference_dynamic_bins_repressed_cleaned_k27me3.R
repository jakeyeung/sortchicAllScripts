...
jsuffix <- "dynamicbins"
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/multinom_celltyping_repressive_cleaned"
dir.create(outdir)
# for (jmark in jmarks){
...
LL.all.lst <- lapply(jmarks, function(jmark){
  ...
  inf.meta <- file.path(indir.meta, paste0("metadata_celltyping_", jmark, ".dynamicbins.2022-02-17.txt"))
