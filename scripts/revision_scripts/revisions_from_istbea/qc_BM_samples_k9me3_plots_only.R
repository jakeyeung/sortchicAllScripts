...
outdir <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/raw_data/count_tables/filtered_count_tables_for_LDA/plots")
...
count.mat.merged.with.old.fewer <- cbind(count.mat.orig[rows.common, cnames.orig.fewer], mat.merged[rows.common, ])
