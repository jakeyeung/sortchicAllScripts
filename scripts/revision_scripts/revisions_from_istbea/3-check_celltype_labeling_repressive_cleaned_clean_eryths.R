...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/celltyping/repressive_cleaned_clean_eryths"
dir.create(outdir)
...
for (jmark in jmarksnew){
  ...
  inf.meta.new <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/metadata/repressive_cleaned_clean_eryths/metadata_plate_experi_batch.merged_with_old_dynbins.dynamicbins.", jmark, ".2022-04-15.txt")
