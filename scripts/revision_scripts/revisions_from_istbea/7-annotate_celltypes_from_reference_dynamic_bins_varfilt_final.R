...
# File: ~/projects/scchic/scripts/scripts_analysis/revisions_from_istbea/7-annotate_celltypes_from_reference_dynamic_bins_varfilt_final.R
# 
...
jsuffix <- "dynamicbins"
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/multinom_celltyping_varfilt_final"
# for (jmark in jmarks){
...
LL.all.lst <- mclapply(jmarks, function(jmark){
  ...
  indir.meta <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/celltyping/varfilt_final"
  inf.meta <- file.path(indir.meta, paste0("metadata_celltyping_", jmark, ".dynamicbins.2022-02-15.txt"))
  ...
  inf.ldaout <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/LDA_outputs_varfilt_final/ldaAnalysis_fripfilt_varfilt_binfilt/lda_outputs.count_mat_varfilt2_dynamicbins.", jmark, "/ldaOut.count_mat_varfilt2_dynamicbins.", jmark, ".Robj")
  ...
  ctypes.to.annotate <- c("Basophils", "Bcells", "CMP", "DCs", "Eryths", "GMP", "Granulocytes", "HSCs", "LT", "MEP", "Monocytes", "MPPs", "NKs", "pDCs", "ST")
