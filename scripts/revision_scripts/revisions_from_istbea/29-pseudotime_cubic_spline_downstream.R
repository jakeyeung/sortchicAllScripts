...
jmarks <- c("k4me3", "k9me3", "k27me3", "k4me1"); names(jmarks) <- jmarks
...
for (jmark in jmarks){
  ...
  outf <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/gam_fits/signal_extrap_vectors_regions_ctypes.", jmark, ".", Sys.Date(), ".rds")
