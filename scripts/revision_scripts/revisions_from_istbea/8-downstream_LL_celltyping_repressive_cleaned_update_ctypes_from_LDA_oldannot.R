...
indir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/multinom_celltyping_update_ctypes_from_LDA_oldannot"
outdir <- indir
...
for (jmark in jmarks){
  ...
  inf <- file.path(indir, paste0("LLmat_by_batch_dynamicbins_", jmark, ".2022-04-11.rds"))
