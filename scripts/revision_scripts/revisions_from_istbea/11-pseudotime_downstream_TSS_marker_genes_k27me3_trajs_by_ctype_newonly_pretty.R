...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/ptimefits_plots_top_hits_TSS_markergenes_colcode_byctype_newonly.aspect_ratio"
dir.create(outdir)
...
for (jmark in jmarks){
  ...
  # ctypes.names <- annot.trajs[[jmark]]$ctypes.namesS
  ctypes.names <- c("Eryths", "Granulocytes"); names(ctypes.names) <- ctypes.names
