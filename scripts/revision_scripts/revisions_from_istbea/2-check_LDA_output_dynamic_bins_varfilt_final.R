...
# File: ~/projects/scchic/scripts/scripts_analysis/revisions_from_istbea/2-check_LDA_output_dynamic_bins_varfilt_final.R
# 
...
dat.meta.var.lst <- parallel::mclapply(jmarks, function(jmark){
  ...
  indir <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/LDA_outputs_varfilt_final/ldaAnalysis_fripfilt_varfilt_binfilt")
  dname <- paste0("count_mat_varfilt2_", jsuffixbins, ".", jmark)
