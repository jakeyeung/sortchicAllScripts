...
# File: ~/projects/scchic/scripts/revision_scripts/revisions_from_istbea/11-pseudotime_downstream_TSS_marker_genes_cleaned.R
# 
...
markergenes <- c("Ly6g", "S100a8", "S100a2", "Chil3", "Sox6", "Tal1", "Gata1", "Ebf1", "Cd79a", "Cd79b", "Hoxa9", "Meis1", "Runx2", "Kit", "Hlf", "Erg", "Cd34", "Stat4", "Tcf7", "Cebpe")
# topn <- 20
...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/ptimefits_plots_top_hits_TSS_markergenes"
dir.create(outdir)
...
for (jmark in jmarks){
  ...
  inf.mat.impute.log <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/batch_effect_corrections/primetime_objects/dat_impute_bins_", jmark, ".2022-04-24.rds")
  mat.impute.log <- readRDS(inf.mat.impute.log)
  ...
  inf.meta <- paste0("/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/batch_effect_corrections/primetime_objects/meta_data_", jmark, ".2022-04-24.txt")
  ...
  for (jctype in ctypes.names){
    ...
    topbins <- subset(dat.fits.long, genesymbol %in% markergenes)$rname
    ...
    for (jbin in topbins){
      ...
      jrow <- count.mat.from.lda[jbin, dat.traj.ctype$cell]
