...
# File: ~/projects/scchic/scripts/scripts_analysis/revisions_from_istbea/8-downstream_LL_celltyping.R
# 
...
jmarks <- c("k9me3", "k4me1", "k4me3", "k27me3"); names(jmarks) <- jmarks
...
jsuffix <- "dynamicbins"
indir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/multinom_celltyping_varfilt_final"
...
for (jmark in jmarks){
  ...
  inf <- file.path(indir, paste0("LLmat_dynamicbins_", jmark, ".2022-02-15.rds"))
