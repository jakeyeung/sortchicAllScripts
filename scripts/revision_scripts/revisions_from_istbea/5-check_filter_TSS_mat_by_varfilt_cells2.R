...
outdir <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/count_mat_TSS_varfilt2"
dir.create(outdir)
...
indir.meta <- "/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/count_mats_varfilt2"
...
infs.meta <- lapply(jmarksnew, function(jmark){
  inf <- file.path(indir.meta, paste0("metadata_with_var.out_dynamic_bins_new_only.varcutoff.", jmark, ".2022-02-14.txt"))
})
