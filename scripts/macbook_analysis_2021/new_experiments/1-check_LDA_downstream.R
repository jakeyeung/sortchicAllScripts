...
outpdf <- paste0("/Users/yeung/Dropbox/macbookpro_data/data/scchic/from_macbook_2021/K562_new_experiment/K562_new_experiments.merge_with_old.", Sys.Date(), ".pdf")
pdf(outpdf, useDingbats = FALSE)
for (jmark in jmarks){
  
  # inf <- paste0("/Users/yeung/Dropbox/macbookpro_data/data/scchic/from_cluster_2021/new_experiments/LDA_outputs/K562/ldaAnalysis_fripfilt_K562_", jmark, "/lda_outputs.count_mat_new_only.K562_", jmark, ".0.8_0.5_3000.2022-01-10/ldaOut.count_mat_new_only.K562_", jmark, ".0.8_0.5_3000.2022-01-10.Robj")
  inf <- paste0("/Users/yeung/Dropbox/macbookpro_data/data/scchic/from_cluster_2021/new_experiments/LDA_outputs/K562/ldaAnalysis_fripfilt_K562_", jmark, "/lda_outputs.count_mat_merged_with_old.K562_", jmark, ".0.8_0.5_3000.2022-01-10/ldaOut.count_mat_merged_with_old.K562_", jmark, ".0.8_0.5_3000.2022-01-10.Robj")
  print(inf)
