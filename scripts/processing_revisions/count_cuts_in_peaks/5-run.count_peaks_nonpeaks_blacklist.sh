...
inmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/revisions_data/new_experiments/fastqs/tagged_bams/K562/merged_bams/bams_split_by_good_cells_NoChrPrefix"
...
for jmark in $jmarks; do
    inbedmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/revisions_data/new_experiments/fastqs/tagged_bams/K562/merged_bams/bams_split_by_good_cells_NoChrPrefix/hiddendomains_outputs/K562_revisions_no_spikeins.${jmark}.GoodCells.sorted.1000.cutoff"
    bedname="K562_revisions_no_spikeins.${jmark}.GoodCells.sorted.1000.cutoff_analysis.bed"
    inbed="${inbedmain}/${bedname}"

    bname="K562_revisions_no_spikeins.${jmark}.GoodCells.sorted.bam"
    inbam=${inmain}/${bname}
