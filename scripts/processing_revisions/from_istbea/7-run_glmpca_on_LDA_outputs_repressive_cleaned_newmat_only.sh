...
outdir="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/glmpca_outputs/repressive_cleaned_newonly"
...
for binskeep in $binskeepvec; do
    for niter in $nitervec; do
        ...
        for jmark in $jmarks; do
			ldadir="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/LDA_outputs_newonly_cleaned_marcin/ldaAnalysis_fripfilt_varfilt_binfilt/lda_outputs.countmat_cleaned_newonly_dynbins.${jmark}.2022-03-22"
			...
			jbase="countmat_cleaned_newonly_dynbins.${jmark}.2022-03-22"
