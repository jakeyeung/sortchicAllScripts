...
outdir="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/glmpca_outputs/clean_again_k27me3"
[[ ! -d $outdir ]] && mkdir $outdir
annotdir="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/celltyping/repressive_cleaned_clean_eryths2"
		...
		for binskeep in $binskeepvec; do
			for niter in $nitervec; do
				...
				for jmark in $jmarks; do
					ldadir=${ldamain}/"lda_outputs.count_mat_${jsuffix}_dynbins.${jmark}.2022-04-15"
					jbase="count_mat_${jsuffix}_dynbins.${jmark}.2022-04-15"
					...
					annotname="metadata_celltyping_${jmark}.dynamicbins.2022-04-16.txt"
