...
annotdir="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/multinom_celltyping_update_ctypes_from_LDA_k4me3_cleaned_k27me3_eryths"
ldamain="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/LDA_outputs_k4me3_cleaned"
		...
		for binskeep in $binskeepvec; do
			for niter in $nitervec; do
				...
				for jmark in $jmarks; do
					ldadir=${ldamain}/"lda_outputs.count_mat_cleaned_no3no7_dynbins_${jsuffix}.${jmark}.2022-04-12"
					jbase="count_mat_cleaned_no3no7_dynbins_${jsuffix}.${jmark}.2022-04-12"
