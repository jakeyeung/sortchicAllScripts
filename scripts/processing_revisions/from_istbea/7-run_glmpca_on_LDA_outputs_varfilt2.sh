...
outdir="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/glmpca_outputs/varfilt_again"
...
annotdir="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/from_jupyterhub/metadata/varfilt_again"
...
ldadir="/nfs/scistore12/hpcgrp/jyeung/data_from_Hubrecht/hpc_hub_oudenaarden/scChiC/new_experiments/LDA_outputs_varfilt_again/ldaAnalysis_fripfilt_varfilt_binfilt"
...
for binskeep in $binskeepvec; do
    for niter in $nitervec; do
        ...
        for jmark in $jmarks; do
			...
			annotname="metadata_plate_experi_batch.varfilt.dynamicbins.${jmark}.2022-02-14.txt"
