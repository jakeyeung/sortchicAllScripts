...
inmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_ZF/for_gensim"
[[ ! -d $inmain ]] && echo "$inmain not found, exiting" && exit 1

outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_python_outputs/ZFWKM_slidewin"
