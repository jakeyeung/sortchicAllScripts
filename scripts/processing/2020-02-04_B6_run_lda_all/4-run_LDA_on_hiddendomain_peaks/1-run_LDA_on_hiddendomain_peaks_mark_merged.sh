...
# # WRAP UP
# while [[ `qstat | grep Convert | wc -l` > 0 ]]; do
...
prefix="BMAllMerged.2020-02-15.from_hiddendomains_marks_merged"
# indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data/ZellerRawData_B6_All_MergedByMarks_final.hiddenDomains_output/count_tables_from_hiddenDomains.rds_format"
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data/ZellerRawData_B6_All_MergedByMarks_final.hiddenDomains_output/count_tables_from_hiddenDomains_marks_merged.rds_format"
