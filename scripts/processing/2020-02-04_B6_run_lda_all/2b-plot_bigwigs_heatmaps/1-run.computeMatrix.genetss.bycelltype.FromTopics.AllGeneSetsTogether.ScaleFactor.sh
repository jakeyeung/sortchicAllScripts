...
for jmark in $jmarks; do
    for dist in $dists; do
        ...
        indir="${basedir}/raw_data/bigwigs_with_R1only/ZellerRawData_B6_All_MergedByMarks_final.bigwigs_by_cluster.MAPQ_40.${bsize}.2020-06-17.offset.r1only${dirsuffix}${dirsuffix2}"
        ...
        outdir="${basedir}/bigwig_outputs/r1onlyFewerClusters/merged_bams.deeptools_outputs.tss.OneDirPretty.AllGsets.2020-06-17.offset.${jsuffix}.r1only${dirsuffix}${dirsuffix2}"
        ...
        infsinput="${indir}/${jmark}-BM_AllMerged.HSPCs.sorted.cleaned.${bsizeout}.CPM${dirsuffix2}.bw ${indir}/${jmark}-BM_AllMerged.Bcells.sorted.cleaned.${bsizeout}.CPM${dirsuffix2}.bw ${indir}/${jmark}-BM_AllMerged.Granulocytes.sorted.cleaned.${bsizeout}.CPM${dirsuffix2}.bw ${indir}/${jmark}-BM_AllMerged.Erythroblasts.sorted.cleaned.${bsizeout}.CPM${dirsuffix2}.bw"
