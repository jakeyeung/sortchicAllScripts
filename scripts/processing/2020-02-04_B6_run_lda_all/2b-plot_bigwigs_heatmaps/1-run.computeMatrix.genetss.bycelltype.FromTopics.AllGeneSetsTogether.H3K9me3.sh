...
dirsuffix=".CPM.Verbose"
outsuffix=".H3K9me3only"
...
for jmark in $jmarks; do
    for dist in $dists; do
        ...
        outdir="${basedir}/bigwig_outputs/r1onlyFewerClusters/merged_bams.deeptools_outputs.tss.OneDirPretty.AllGsets.2020-06-17.offset.${jsuffix}.r1only${dirsuffix}${outsuffix}"
        ...
        # infsinput="${indir}/${jmark}-BM_AllMerged.HSPCs.sorted.cleaned.${bsizeout}.CPM.bw ${indir}/${jmark}-BM_AllMerged.Bcells.sorted.cleaned.${bsizeout}.CPM.bw ${indir}/${jmark}-BM_AllMerged.Granulocytes.sorted.cleaned.${bsizeout}.CPM.bw ${indir}/${jmark}-BM_AllMerged.Erythroblasts.sorted.cleaned.${bsizeout}.CPM.bw"

        infsinput="${indir}/${jmark}-BM_AllMerged.HSCs_topic22.sorted.cleaned.${bsizeout}.CPM.bw ${indir}/${jmark}-BM_AllMerged.Bcells_topic21.sorted.cleaned.${bsizeout}.CPM.bw ${indir}/${jmark}-BM_AllMerged.Neutrophils_topic9.sorted.cleaned.${bsizeout}.CPM.bw ${indir}/${jmark}-BM_AllMerged.ErythLinneg_topic10.sorted.cleaned.${bsizeout}.CPM.bw"
