...
for jmark in $jmarks; do
    for dist in $dists; do
        ...
        refs="${refdir}/MouseBM_TSS.HSCs.bsize_2.bed ${refdir}/MouseBM_TSS.Bcell.bsize_2.bed ${refdir}/MouseBM_TSS.Neutrophil.bsize_2.bed ${refdir}/MouseBM_TSS.Erythroblast.bsize_2.bed"
