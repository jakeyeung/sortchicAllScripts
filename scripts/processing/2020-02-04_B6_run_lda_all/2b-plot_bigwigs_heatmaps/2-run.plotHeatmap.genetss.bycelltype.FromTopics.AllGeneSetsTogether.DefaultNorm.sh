...
#     for jdist in $jdists; do
        ...
        # --regionsLabel BcellsSpec GranuSpec ErythSpec HSPCsSpec
            ...
            cmd=". /hpc/hub_oudenaarden/jyeung/software/anaconda3/etc/profile.d/conda.sh; conda activate py3; plotHeatmap -m $inf -out $outf --colorMap YlGnBu --heatmapHeight 15 --sortRegions descend --sortUsingSamples 1 --averageTypeSummaryPlot mean --regionsLabel HSPCsSpec BcellsSpec GranuSpec ErythSpec --samplesLabel HSPCs Bcells Granu Eryth --legendLocation best --yAxisLabel DefaultNorm"
