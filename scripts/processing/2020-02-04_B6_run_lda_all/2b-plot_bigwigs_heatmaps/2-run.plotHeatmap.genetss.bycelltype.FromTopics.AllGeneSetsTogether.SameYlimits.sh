...
#     for jdist in $jdists; do
        ...
        indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/bigwig_outputs/r1onlyFewerClusters/merged_bams.deeptools_outputs.tss.OneDirPretty.AllGsets.2020-06-17.offset.${jsuffix}.r1only${dirsuffix}"
        ...
        for inf in `ls -d $indir/*.tab.gz`; do
            ...
            outf=${outdir}/plotHeatmap.${bname}.mean${dirsuffix}.ymin_${ymin}.ymax_${ymax}.png
        ...
        # --regionsLabel BcellsSpec GranuSpec ErythSpec HSPCsSpec
            ...
            cmd=". /hpc/hub_oudenaarden/jyeung/software/anaconda3/etc/profile.d/conda.sh; conda activate py3; plotHeatmap -m $inf -out $outf --colorMap YlGnBu --heatmapHeight 15 --sortRegions descend --sortUsingSamples 1 --averageTypeSummaryPlot mean --regionsLabel HSPCsSpec BcellsSpec GranuSpec ErythSpec --samplesLabel HSPCs Bcells Granu Eryth --legendLocation best --yAxisLabel CPM --yMin $ymin --yMax $ymax"
