...
# dists="25000 50000 100000"

dists="3000 5000 10000 25000 50000 100000"

jmarks="H3K4me1 H3K4me3 H3K27me3"

# jsuffix="MouseBMFromTopics.refmark_H3K27me3.2000/MouseBM_TSS_FromTopics.refmark_H3K27me3.HSPCs.bsize_2.bed"

# markprefix="refmark_H3K27me3"
markprefix="refmark_H3K4me1"
...
dsuffall=${dirsuffix}.${dirsuffix2}.${dirsuffix3}
...
for jmark in $jmarks; do
    for dist in $dists; do
        ...
        indir="${basedir}/raw_data/bigwigs_with_R1only/ZellerRawData_B6_All_MergedByMarks_final.bigwigs_by_cluster.MAPQ_40.${bsize}.2020-06-17.offset.r1only${dsuffall}"
        # echo $indir
        # exit 0
        ...
        outdir="${basedir}/bigwig_outputs/r1onlyFewerClusters/merged_bams.deeptools_outputs.tss.OneDirPretty.AllGsets.2020-06-17.offset.${jsuffix}.r1only${dsuffall}.${markprefix}"
        ...
        refs="${refdir}/MouseBM_TSS_FromTopics.${markprefix}.HSPCs.bsize_2.bed ${refdir}/MouseBM_TSS_FromTopics.${markprefix}.Bcell.bsize_2.bed ${refdir}/MouseBM_TSS_FromTopics.${markprefix}.Granu.bsize_2.bed ${refdir}/MouseBM_TSS_FromTopics.${markprefix}.Eryth.bsize_2.bed"
        ...
        infsinput="${indir}/${jmark}-BM_AllMerged.HSPCs.sorted.cleaned.${bsizeout}.${dirsuffix3}.${dirsuffix2}.bw ${indir}/${jmark}-BM_AllMerged.Bcells.sorted.cleaned.${bsizeout}.${dirsuffix3}.${dirsuffix2}.bw ${indir}/${jmark}-BM_AllMerged.Granulocytes.sorted.cleaned.${bsizeout}.${dirsuffix3}.${dirsuffix2}.bw ${indir}/${jmark}-BM_AllMerged.Erythroblasts.sorted.cleaned.${bsizeout}.${dirsuffix3}.${dirsuffix2}.bw"

        for inf in $infsinput; do
            [[ ! -e $inf ]] && echo "$inf not found, exiting" && exit 1
        done

        outf="${outdir}/computeMatrix.${jmark}.${bsize}.${jsuffix}.dist_${dist}.${markprefix}.tab.gz"
