...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data/ZellerRawData_B6_All_MergedByMarks_final.hiddenDomains_output/count_tables_from_hiddenDomains_marks_merged.NewCountFilter"
...
for mark in ${marks}; do
    ...
    outftab=${outdir}/${bname}.NewCountFilter.txt
