...
ps="/home/hub_oudenaarden/jyeung/projects/scChiC/scripts/processing/2020-02-04_B6_run_lda_all/2-make_bigwigs/FewerClusters/calculate_default_norm_factor_for_deeptools.py"
...
for inbam in `ls -d $indir/*.bam`; do
    ...
    cmd=". /hpc/hub_oudenaarden/jyeung/software/anaconda3/etc/profile.d/conda.sh; conda activate py3; python $ps -infile $inbam -outfile $outf"
