...
def main():
    ...
    parser.add_argument('-dividefactor', metavar='DIVIDEFACTOR', default=1.0, 
                        help='Scale factor to divide by')
    ...
    sfbefore = 1 / args.dividefactor

    sfafter = sfbefore * bam_mapped_total  # cancels out the normalization factor
