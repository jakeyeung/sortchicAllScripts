...
inmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data/ZellerRawData_B6_All_MergedByMarks_final.bams_by_cluster.MAPQ_40.2020-06-17/bamFilteredByTlen_$tlen"
...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/dinuc_freq/tlen_${tlen}"
...
for inf in `ls -d $inmain/*.bam`; do
    ...
    cmd=". /hpc/hub_oudenaarden/jyeung/software/anaconda3/etc/profile.d/conda.sh; conda activate scmo4_NewCountFilters; python $ps -infile $inf -outprefix $outf -refpath $refpath -baseseq AT -mapqthres 40 -upstrm_extend 0 -downstrm_extend $extend"
    # cmd=". /hpc/hub_oudenaarden/jyeung/software/anaconda3/etc/profile.d/conda.sh; conda activate scmo4_NewCountFilters; python $ps -infile $inf -outprefix $outf -refpath $refpath -baseseq AT -mapqthres 40 -upstrm_extend 200 -downstrm_extend 0"
