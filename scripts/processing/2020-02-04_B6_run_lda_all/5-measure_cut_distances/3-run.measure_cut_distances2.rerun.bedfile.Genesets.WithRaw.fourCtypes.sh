...
outmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/cut_distances_all_clusters2.rerun.bedfile_GeneSets_winsize_${dist}.withraw.fourCtypes"
[[ ! -d $outmain ]] && mkdir $outmain

ctypes="Erythroblast Bcell Neutrophil HSCs"
