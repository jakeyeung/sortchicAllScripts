...
prefix="B6BM_All_allmarks.2020-02-11.var_filt.UnenrichedAndAllMerged.${jsuffix}"

indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_postLDA_var_BM.${jsuffix}.final_Unenriched_and_AllMerged"
