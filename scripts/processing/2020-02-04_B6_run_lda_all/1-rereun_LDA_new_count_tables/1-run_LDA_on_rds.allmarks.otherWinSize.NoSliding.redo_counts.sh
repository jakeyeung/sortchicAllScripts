...
# indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_postLDA_var_blood_varfilt"
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_mat_all_and_HSCs"
[[ ! -d $indir ]] && echo "$indir not found, exiting" && exit 1

# jsuffix="KeepBestPlat"
# prefix="B6BM_All_allmarks.2020-03-06.var_filt.UnenrichedAndAllMerged.${jsuffix}"

outmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisBins_redocounts_all_and_HSC"  
