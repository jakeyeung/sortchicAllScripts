...
prefix="B6BM_All_allmarks.2020-02-04.var_filt.UnenrichedAndAllMerged"
...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_postLDA_var_BM.final_Unenriched_and_AllMerged"
