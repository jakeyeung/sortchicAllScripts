...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data/ZellerRawData_B6_All_MergedByMarks_final.count_tables_SlidingWindow${outsuffix}"
...
for prefix in $prefixs; do
    ...
    outf=${outdir}/${prefix}.countTableTSS.mapq_${mapq}.SlidingWindow_${dist}.blfiltered.csv
