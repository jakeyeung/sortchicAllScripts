...
prefix="B6BM_All_allmarks.2020-02-06.var_filt.UnenrichedAndAllMerged.KeepBestPlates"

indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_postLDA_var_BM.KeepBestPlates.final_Unenriched_and_AllMerged"
