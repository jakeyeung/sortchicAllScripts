...
jsuffix="RemoveLargePeaks"
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/GLMPCA_outputs.Faster.pois.${jsuffix}KeepBestPlates2.LDAfromPeaks"
...
bname="BM_${jmark}.BM_AllMerged.VarCorrection.Poisson.GLMPCA.${jsuffix}"
