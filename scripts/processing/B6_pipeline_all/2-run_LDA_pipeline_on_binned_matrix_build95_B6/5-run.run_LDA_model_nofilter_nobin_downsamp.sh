...
marks="H3K27me3 H3K9me3 H3K4me3 H3K4me1"
...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_macbook/count_mat_binfilt_cellfilt_for_LDA/downsampled"
prefix="B6"
counts=2000
...
for mark in $marks; do
    ...
    inf=$indir/"${prefix}_${mark}_pcutoff_0.95_binfilt_cellfilt.2019-06-03.downsamp_${counts}.RData"
    outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisBins_${mindist}/lda_outputs.meanfilt_${meanmax}.cellmin_${cellmin}.cellmax_${cellmax}.binarize.${binarize}.no_filt.downsamp_${counts}"
