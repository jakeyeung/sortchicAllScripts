...
for mark in $marks; do
    ...
    indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisBins_BinFiltCellFilt2/lda_outputs.meanfilt_999.cellmin_0.cellmax_999999.binarize.${jbin}.no_filt.stringent_filter"
