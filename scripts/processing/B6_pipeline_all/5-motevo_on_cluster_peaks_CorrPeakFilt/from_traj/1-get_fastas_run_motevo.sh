...
scratchmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/tfbs_output_singlegene_${prefix}_${suffix}_${suffix2}/${jmark}"

[[ -d $scratchmain ]] && echo "$scratchmain found, exiting" && exit 1
[[ ! -d $scratchmain ]] && mkdir -p $scratchmain

## BEGIN GET FASTA ## 
# /hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/merged_cluster_bam_hiddenDomains_output_build95_B6/merged_across_clusters_H3K4me1/merged_H3K4me1.1000.cutoff_analysis.blacklistfilt.CorrPeakFilt.fromCountMat.annot.bed
windowsf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/merged_cluster_bam_hiddenDomains_output_${suffix}/merged_across_clusters_${jmark}/merged_${jmark}.1000.cutoff_analysis.blacklistfilt.${suffix2}.fromCountMat.annot.bed"
