...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/bam_cluster_merged/sorted_bams_${suffix}"
[[ ! -d $outdir ]] && mkdir $outdir
# wd="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/bam_split_by_bc/count_thres-0_${suffix}.withchr"
wd="/hpc/hub_oudenaarden/jyeung/data/histone-mods-Ensembl95-B6-split_by_bc"
