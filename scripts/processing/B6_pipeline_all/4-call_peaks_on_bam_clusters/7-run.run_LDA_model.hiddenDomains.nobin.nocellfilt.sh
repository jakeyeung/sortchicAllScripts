...
for mark in $marks; do
    ...
    inf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/count_mats_all/count_mats.fromHiddenDomains.${mindist}_${suffix}/CorrPeakFilt/${experiname}-${mark}.merged.NoCountThres.hiddenDomains.${suffix2}.Robj"
