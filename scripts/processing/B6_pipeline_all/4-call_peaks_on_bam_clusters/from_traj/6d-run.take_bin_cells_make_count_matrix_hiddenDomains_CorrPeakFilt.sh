...
suffix0="build95_B6"  # does not change whether from traj or from cluster
...
bamnamesdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_macbook/bamlist_for_peak_analysis_${suffix0}"
