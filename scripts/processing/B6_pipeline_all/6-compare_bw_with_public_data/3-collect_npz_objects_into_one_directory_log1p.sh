...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/comparisons_with_pseudobulk/merged_softlinks_log1p_build95_B6"
[[ ! -d $outdir ]] && mkdir $outdir

for d in $(ls -d $dmain/*build95_B6_log1p_bigwigs); do
