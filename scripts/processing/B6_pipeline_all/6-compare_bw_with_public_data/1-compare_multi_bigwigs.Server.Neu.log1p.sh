...
chicbwdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/bam_cluster_merged/bigwigs_${suffix}/$subdir"
...
for ctype in $ctypes; do
    ...
    for mark in $marks; do
        echo $mark
        infbase="$inbase/${mark}_${ctype}_reltoinput.bw"
