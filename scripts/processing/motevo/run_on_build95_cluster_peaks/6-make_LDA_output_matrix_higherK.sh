...
for jmark in $jmarks; do
    inf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisHiddenDomains_1000_${suffix}_${jdate}/lda_outputs.meanfilt_${jmeanfilt}.cellmin_${jcellmin}.cellmax_${jcellmax}.binarize.${jbin}/lda_out_meanfilt.PZ-BM-${jmark}.CountThres0.K-25_${highestK}.Robj"
    # DEBUG HERE REMOVE AFTE RDONE
    echo $inf
    exit 0
    # DEBUG HERE REMOVE AFTE RDONE
