...
bs="/home/hub_oudenaarden/jyeung/projects/scChiC/scripts/processing/motevo/permute_sitecount_matrix/summarize_FOV_permuted_matrix_general.sh"
jmark="H3K4me1"
...
outf=$outdir/FOV_permute_summary.txt
# echo $outf
