...
suffix="build95"
scratchmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/tfbs_output_singlegene_${suffix}/${jmark}"
...
## BEGIN GET FASTA ## 
windowsf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/merged_bam_hiddenDomains_output_${suffix}/BM_${jmark}_merged.1000.cutoff/BM_${jmark}_merged.1000.cutoff_analysis.blacklistfilt.annot.bed"
