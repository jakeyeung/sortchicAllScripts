...
suffix="build95.cells_from_bin_analysis"
jdate="2019-03-27"
jcellmin=0
jcellmax=9999999
highestK=50
...
for jmark in $jmarks; do
    inf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisHiddenDomains_1000_${suffix}_${jdate}/lda_outputs.meanfilt_${jmeanfilt}.cellmin_${jcellmin}.cellmax_${jcellmax}.binarize.${jbin}/lda_out_meanfilt.PZ-BM-${jmark}.CountThres0.K-12_15_20_25_${highestK}.Robj"
    # inf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisHiddenDomains_1000_${suffix}_${jdate}/lda_outputs.meanfilt_1.cellmin_${jcellmin}.cellmax_500000.binarize.${jbin}/lda_out_meanfilt.PZ-BM-${jmark}.CountThres0.K-12_15_20_25_${highestK}.Robj"
    ...
    outf=$outdir/$outname
    # outnamefixed="hiddenDomains_cellmin_${jcellmin}-cellmax_${jcellmax}-binarize_${jbin}-BM_${jmark}.filt_${thres}.center_${jcenter}_K${highestK}_techrepnamefix.txt"
    # outffixed=$outdir/$outnamefixed
    ...
    # echo "Fixing colnames"
    # Rscript $fixscript $outf $outffixed
done
