...
inf="/hpc/hub_oudenaarden/jyeung/data/scChiC/tfbs_output_singlegene_${suffix}/${mark}/motevo_outputs/bed/merged_bed_closestbed_long/motevo_merged.closest.long.bed"
