...
# load LDA
dirmain <- "/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisBins_MetaCell/lda_outputs.meanfilt_10.cellmin_100.cellmax_500000.binarize.TRUE.no_filt"

jmarks <- c("H3K4me1", "H3K4me3")

infs <- lapply(jmarks, function(jmark) file.path(dirmain, paste0("lda_out_meanfilt.BM-", jmark, ".CountThres0.K-15_20_25_30_35.Robj")))
...
save(mat.merged, coldat, bm.lst, bm.anchors, bm.integrated, file = "/hpc/hub_oudenaarden/jyeung/data/scChiC/integrated_datasets/integrated_H3K4me1_H3K4me3_seurat.RData")
