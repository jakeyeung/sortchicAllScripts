...
infs <- lapply(jmarks, function(jmark) file.path(dirmain, paste0("lda_out_meanfilt.BM-", jmark, ".CountThres0.K-", kstr, ".Robj")))
...
mat.merged <- bind_cols(mat.merged.lst[["H3K27me3"]], mat.merged.lst[["H3K9me3"]])
...
save(mat.merged, coldat, bm.lst, bm.anchors, bm.integrated, file = "/hpc/hub_oudenaarden/jyeung/data/scChiC/integrated_datasets/integrated_H3K27me3_H3K9me3_seurat.RData")
