...
bcmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/barcode_summaries_K562_round2/summarized"
...
for bcf in $(ls -d $bcmain/barcode_summary.PZ*.thres.0.chip.*.txt); do
    ...
    outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/bam_split_by_bc_K562_round2/count_thres-0/$bname"
