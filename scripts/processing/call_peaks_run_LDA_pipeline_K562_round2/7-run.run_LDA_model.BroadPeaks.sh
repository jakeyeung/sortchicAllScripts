...
for mark in $marks; do
    inf="/hpc/hub_oudenaarden/jyeung/data/scChiC/count_mat_${cell}/count_mats.${meth}.${pvalcutoff}.${mindist}/PZ-${cell}-${mark}.merged.${meth}.NoCountThres.Robj"
    ...
    cellmin="100"
    cellmax="500000"
    outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/LDA_out_${cell}/ldaAnalysisBroadpeaks_${pvalcutoff}_${mindist}/lda_outputs.meanfilt_${meanmax}.cellmin_${cellmin}.cellmax_${cellmax}.binarize.${binarize}"
