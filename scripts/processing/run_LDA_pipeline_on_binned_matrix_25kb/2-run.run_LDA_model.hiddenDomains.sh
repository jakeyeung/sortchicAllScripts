...
for mark in $marks; do
    ...
    inf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/count_mats_all/count_mats_binned_${jdist}kb/${cell}-${mark}-${jdist}kb.AvO_filt.Robj"
    ...
    outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisBins_${mindist}_binsize_${jdist}kb/lda_outputs.binsize_${jdist}kb.meanfilt_${meanmax}.cellmin_${cellmin}.cellmax_${cellmax}.binarize.${binarize}"
