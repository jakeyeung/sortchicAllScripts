...
bin=$indir/*H3K4me1*.retagged.bam
bout=$outdir/H3K4me1-BM_SC-merged.tagged.bam
...
samtools merge -f $bout $bint --output-fmt BAM
samtools index $bout

# Merge H3K27me3: Unenriched, Linneg, and StemCells
bin=$indir/*H3K27me3*.retagged.bam
bout=$outdir/H3K27me3-BM_Linneg_SC-merged.tagged.bam
samtools merge -f $bout $bin --output-fmt BAM
samtools index $bout

# Merge H3K9me3: Unenriched, Linneg, and StemCells
bin=$indir/*H3K9me3*.retagged.bam
bout=$outdir/H3K9me3-BM_Linneg_SC-merged.tagged.bam
samtools merge -f $bout $bin --output-fmt BAM
samtools index $bout
