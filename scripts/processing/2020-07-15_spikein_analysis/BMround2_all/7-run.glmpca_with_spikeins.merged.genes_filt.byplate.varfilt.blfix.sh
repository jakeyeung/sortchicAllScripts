...
outdir="${prefix}/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/glmpcaPois_mouse_spikein_BMround2all.varfilt.blfix"
...
inspike="${prefix}/jyeung/data/scChiC/from_rstudioserver/quality_control_BM_round2_all.blfix/spikein_info_BM_round2_all.blfix.txt"
...
indir="${prefix}/jyeung/data/scChiC/from_rstudioserver/quality_control_BM_round2_all.blfix/varfilt"
