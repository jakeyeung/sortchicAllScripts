...
inmain="${inbase0}/hiddendomains_outputs_minlength_2500.FromR.maxcount_80_mincount_0_minprob_0.6"
...
for mark in $marks; do
    echo $mark
    outdir="${inbase0}/hd_merged.${mark}.minlength_${minlength}.FromR.maxcount_60_maxcount40"
