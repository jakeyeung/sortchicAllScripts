...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_BM_round2_all.stainlater/varfilt"
...
prefix="mouse_spikein_BMround2all.stainlater.varfilt"
