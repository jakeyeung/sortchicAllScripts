...
outdir="${prefix}/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/glmpcaPois_mouse_spikein_BMround2all.stainlater"
...
inmain=""
indir="${prefix}/jyeung/data/scChiC/from_rstudioserver/quality_control_BM_round2_all.stainlater"
