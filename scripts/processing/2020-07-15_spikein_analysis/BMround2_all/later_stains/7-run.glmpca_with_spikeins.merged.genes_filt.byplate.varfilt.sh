...
outdir="${prefix}/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/glmpcaPois_mouse_spikein_BMround2all.stainlater.varfilt"
...
# inmain=""
indir="${prefix}/jyeung/data/scChiC/from_rstudioserver/quality_control_BM_round2_all.stainlater/varfilt"
[[ ! -d $indir ]] && echo "$indir not found, exiting" && exit 1
inspike="${indir}/spikein_info_BM_round2_all.txt"
