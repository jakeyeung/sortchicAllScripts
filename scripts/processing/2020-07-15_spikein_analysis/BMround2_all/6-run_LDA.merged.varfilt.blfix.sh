...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_BM_round2_all.blfix/varfilt"
...
prefix="mouse_spikein_BMround2all_varfilt.blfix"
