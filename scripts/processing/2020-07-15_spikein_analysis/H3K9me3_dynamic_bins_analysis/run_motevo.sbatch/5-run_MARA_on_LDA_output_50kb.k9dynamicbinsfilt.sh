...
marainputdir="${pathprefix}/scChiC/mara_analysis_dynamic_bins_1000"
...
for jmark in $jmarks; do
    ...
    # Nfname="hiddenDomains_motevo_merged.closest.long.scale_0.center_0.byrow_0.${jmark}.txt"
    Nfname="hiddenDomains_motevo_merged.closest.long.scale_0.center_0.byrow_0.${jmarksitecounts}.txt"  # always H3K9me3
    ...
    outdir="${marainputdir}/${jmark}/mara_output/${Ebase}-${Nbase}"
