...
# jgene="S100a7a"
# jgenes="Ebf1 S100a8"
jgenes="Hoxc10 Hoxa7 Hoxd13"

for jgene in $jgenes; do
    ...
    jwidth=8
    jheight=8
    jname="${jgene}_normby_${normby}_jwidth_${jwidth}_height_${jheight}_percentile_${percentile}"
    ...
    outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_jupyter/scchic_cuts_visualizations_from_sbatch.sigmas.FourMarks.ByGene.final2"
    # outtxtprefix="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_jupyter/scchic_cuts_visualizations_from_sbatch.sigmas.FourMarks.ByGene.final/"
    ...
    for jmark in $jmarks; do
        # outtxtprefix="${outdir}/${jname}.${jmark}.inputs"
