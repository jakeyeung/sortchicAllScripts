...
inmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/VAN5039_K562_round2/tagged_bams/G1_sorted/merged_bams"
outdir="${inmain}/countTablesAndRZr1only_CountTables.NewFilters"
