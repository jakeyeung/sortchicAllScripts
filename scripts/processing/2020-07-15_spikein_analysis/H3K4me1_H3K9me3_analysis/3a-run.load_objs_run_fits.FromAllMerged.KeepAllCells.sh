...
indat="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/H3K4me1_H3K9me3_analysis/double_staining_input/${experi}_${suffix}/${experi}_${suffix}.clstr_by_louvain_H3K4me1xH3K9me3.removeNA_FALSE.RData"
