...
cmd=". /hpc/hub_oudenaarden/jyeung/software/anaconda3/etc/profile.d/conda.sh; conda activate R3.6; Rscript $rs -mark1 $mark1 -mark2 $mark2 -inf1 $inf1 -inf2 $inf2 -infdbl $infdbl -outprefix $outprefix --RemoveNA"
