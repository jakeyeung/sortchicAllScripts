...
inmain="/hpc/hub_oudenaarden/avo/chictaps/OUD4702"
...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/VAN4702_ChIC_TAPS/tagged_bams"
...
for inbam in `ls -d $inmain/*.bam`; do
    ...
    sortedbam=$outdir/${bname}.sorted.bam
