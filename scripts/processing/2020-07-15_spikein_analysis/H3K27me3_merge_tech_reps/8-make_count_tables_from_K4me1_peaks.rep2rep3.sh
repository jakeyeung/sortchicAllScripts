...
# rep2
# inmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BMround2all_VAN5046_VAN5109_VAN5230_BM_VAN5232_VAN5233_VAN5234_VAN5235_VAN5236"
inmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BM_H3K27me3_tech_rep_merged/raw_demultiplexed"
outmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BM_H3K27me3_tech_rep_merged/raw_demultiplexed"  # into rep3reseq
...
outdir="${outmain}/count_tables_from_K4me1_rep2_rep3reseq_bams_together"
...
for mark in ${marks}; do
    ...
    # for inbam in `ls -d ${bamdir}/PZ-BM-rep3-*${mark}-*.bam`; do
        ...
        bname=${bname}
        outftab=${outdir}/${bname}.count_table_peaks_from_K4me1.txt
