...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BM_H3K27me3_tech_rep_merged/raw_demultiplexed/count_tables_from_TSS/dist_10000/for_LDA"
...
prefix="mouse_spikein_BMround2all_rep2rep3reseq_TSS"
...
for inf in `ls -d $indir/*.varfilt.rds`; do
