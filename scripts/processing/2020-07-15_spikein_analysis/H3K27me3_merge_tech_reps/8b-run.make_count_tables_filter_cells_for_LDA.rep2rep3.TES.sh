...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BM_H3K27me3_tech_rep_merged/raw_demultiplexed/count_tables_from_TES"
...
infs=$(ls -d *.txt | tr '\n' ' ')
echo $infs
outf=${outdir}/"PZ-BM-rep3-H3K27me3-rep2rep3reseq.TES.varfilt.rds"
