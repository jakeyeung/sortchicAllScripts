...
inbase="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BM_H3K27me3_tech_rep_merged/raw_demultiplexed/bams_split_by_cluster/bams_merged_by_cluster"
outbase="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BM_H3K27me3_tech_rep_merged/raw_demultiplexed/hiddendomains_outputs"

# maxcounts=40  # not used here need to run Rscript
minlength=2000  # seems to work well at 1k?
# minlength=5000  # seems to work well at 1k?
outmain="${outbase}/hiddendomains_outputs_minlength_${minlength}"
