...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BM_H3K27me3_tech_rep_merged/raw_demultiplexed/count_tables_from_peaks.from_sitecount_mat"
...
infs=$(ls -d *.txt | tr '\n' ' ')
echo $infs
outf=${outdir}/"PZ-BM-rep2rep3reseq-H3K27me3.peaks.varfilt.rds"
