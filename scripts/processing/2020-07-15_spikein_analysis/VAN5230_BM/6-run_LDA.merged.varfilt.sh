...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_count_tables_mouse_for_lda.chromo2spikeinfilt.merged_across_runs/varfilt"
...
prefix="mouse_spikein_VAN5046_VAN5230_BM_varfilt"
