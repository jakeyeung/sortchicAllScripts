...
infannot="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/H3K4me1_H3K9me3_analyses/cluster_tables.withdbl/cluster_tables_H3K9me3_BM_all_round2.txt"
...
for f in `ls -d $indir/*K9me3*.bam`; do
    bname=$(basename $f)
    bname=${bname%.*}
