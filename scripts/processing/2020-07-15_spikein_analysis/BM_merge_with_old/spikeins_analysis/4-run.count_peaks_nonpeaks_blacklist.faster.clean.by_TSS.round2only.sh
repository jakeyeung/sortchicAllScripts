...
outdir="${inmain}/counts_in_peaks_vs_nonpeaks_vs_blacklist.BM-AllMerged3.round2only.TSS"
...
# chromos="7"
inbed="/hpc/hub_oudenaarden/jyeung/data/databases/refseq/MmRefseqTss.chromorenamed.10000.again.nochromo.sorted.bed"
