...
indir1="${inmain}/split_by_cluster.MAPQ_40.batch1/merged_bam"
...
indir2="${inmain}/split_by_cluster.MAPQ_40.batch2/merged_bam"
...
outdir="${inmain}/merged_bams.first_and_second_rounds"
[[ ! -d $outdir ]] && mkdir $outdir

# jmarks="H3K4me1 H3K4me3 H3K27me3"  # K9me3 separate
jmarks="H3K4me1 H3K4me3"  # K27me3 K9me3 separate

jclsts="Basophils Bcells DCs Eryths Granulocytes HSPCs NKs pDCs"
...
# k27me3
jmarks="H3K27me3"
jclsts="Bcells DCs Eryths Granulocytes HSPCs NKs pDCs"
for jclst in $jclsts; do
    for jmark in $jmarks; do
        BNAME=${outdir}/${jmark}_${jclst}.sbatch_log
        DBASE=$(dirname "${BNAME}")
