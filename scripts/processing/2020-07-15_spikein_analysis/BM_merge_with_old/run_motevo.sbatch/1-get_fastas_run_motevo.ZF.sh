...
## BEGIN GET FASTA ## 
windowsf="/hpc/hub_oudenaarden/jyeung/data/zebrafish_scchic/hiddendomains_outputs.FromR/hd_merged.${jmark}.minlength_1000/merged.${jmark}.minlength_${minlength}.cutoff_analysis.merged.nochr.bed"
...
fastaref="/hpc/hub_oudenaarden/jyeung/data/databases/fasta/Danio_rerio.GRCz11.dna.primary_assembly.fa"
