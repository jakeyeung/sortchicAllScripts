...
cdirname="count_mats_peaks_norm_merged"
ndirname="sitecount_mats"
outprefix="NoIntercept_"
...
# for jmark in $jmarks; do
    ...
    Nfname="hiddenDomains_motevo_merged.closest.long.scale_0.center_0.byrow_0${nsuffix}.${jmark}.txt"
