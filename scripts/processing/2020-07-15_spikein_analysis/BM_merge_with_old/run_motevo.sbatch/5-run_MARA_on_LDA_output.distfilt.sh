...
for dist in $dists; do
    for jmark in $jmarks; do
        ...
        Nfname="hiddenDomains_motevo_merged.closest.long.distfilt_${dist}.scale_0.center_0.byrow_0.${jmark}.txt"
        ...
        echo ". /hpc/hub_oudenaarden/jyeung/software/anaconda3/etc/profile.d/conda.sh; conda activate R3.6; bash $runscript $E $outdir $N" | qsub -l h_rt=${jtime} -l h_vmem=${jmem} -o ${BNAME}.out -e ${BNAME}.err -pe threaded 1 -m beas -M j.yeung@hubrecht.eu -N MARA_${dist}_${jmark}
