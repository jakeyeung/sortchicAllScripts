...
# indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BMAllMerged2.from_peaks"
# indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BMAllMerged2.from_peaks/filtNAcells_allbins"
# indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BMround2.from_peaks.sitecount_mat/filtNAcells_allbins"
# indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BMAllMerged2.from_peaks.sitecount_mat/filtNAcells_allbins"
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BMAllMerged2.from_peaks.sitecount_mat/filtNAcells_topbins"
...
# prefix="mouse_spikein_BMround2all_MergeWithOld.frompeaks.filtNAcells_topbins.from_sitecount_mat"
prefix="mouse_spikein_BMround2all_MergeWithOld.frompeaks.filtNAcells_allbins.from_sitecount_mat"
