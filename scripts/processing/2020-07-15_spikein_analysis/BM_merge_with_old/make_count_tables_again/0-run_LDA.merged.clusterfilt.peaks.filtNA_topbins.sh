...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BMAllMerged2.from_peaks/filtNAcells_topbins"
...
prefix="mouse_spikein_BMround2all_MergeWithOld.frompeaks.filtNAcells_topbins"
