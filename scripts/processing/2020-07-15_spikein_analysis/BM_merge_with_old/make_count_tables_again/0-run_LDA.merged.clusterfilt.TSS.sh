...
# jsuffix="from_TSS"
jsuffix="from_TSS.dist_10000"
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BMAllMerged2.${jsuffix}"
...
prefix="mouse_spikein_BMround2all_MergeWithOld.${jsuffix}.RemoveDupRows"
...
for inf in `ls -d $indir/*.rds`; do
    ...
    cmd="cd $workdir; . /hpc/hub_oudenaarden/jyeung/software/anaconda3/etc/profile.d/conda.sh; conda activate R3.6; Rscript $rs $inf $outdir --topics $topics --projname $bname --RemoveDupRows"
