...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BMround2.from_peaks.sitecount_mat/filtNAcells_allbins.from_same_annot_file"
...
prefix="mouse_spikein_BMround2all_MergeWithOld.frompeaks.filtNAcells_allbins.from_sitecount_mat.from_same_annot_file"
