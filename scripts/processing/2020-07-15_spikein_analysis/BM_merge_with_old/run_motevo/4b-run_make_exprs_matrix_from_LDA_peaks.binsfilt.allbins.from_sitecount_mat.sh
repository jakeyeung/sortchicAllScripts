...
inmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/ldaAnalysisBins_mouse_spikein_BMround2all_MergeWithOld.frompeaks.filtNAcells_allbins.from_sitecount_mat"
...
for jmark in $jmarks; do
    ...
    # jsuffix="lda_outputs.count_mat_from_hiddendomains.${jmark}.filtNAcells_allbins.K-30.binarize.FALSE/ldaOut.count_mat_from_hiddendomains.${jmark}.filtNAcells_allbins.K-30.Robj"
    jsuffix="lda_outputs.count_mat_from_sitecount_mat.${jmark}.filtNAcells_allbins.K-30.binarize.FALSE/ldaOut.count_mat_from_sitecount_mat.${jmark}.filtNAcells_allbins.K-30.Robj"
    inf=${inmain}/${jsuffix}
    ...
    outdir="${outmain}/count_mats_peaks_norm.sitecount_mat"
