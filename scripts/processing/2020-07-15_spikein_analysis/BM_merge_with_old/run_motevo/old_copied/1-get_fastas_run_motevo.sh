...
prefix="cluster"
suffix="BM-AllMerged3"
suffix2="Peaks"
# minlength=1000
scratchmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/tfbs_output_${prefix}_${suffix}_${suffix2}/${jmark}"
...
## BEGIN GET FASTA ## 
# windowsf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data/ZellerRawData_B6_All_MergedByMarks_final.hiddenDomains_output/hd_merged.${jmark}.minlength_${minlength}/merged.${jmark}.minlength_${minlength}.cutoff_analysis.merged.withchr.annotated.bed"
windowsf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BM_merge_first_and_second.same_annot_file/merged_bams.first_and_second_rounds/hd_merged.${jmark}.FromR.maxcount_40_60_R/merged.${jmark}.cutoff_analysis.merged.withchr2.annotated.bed"
...
sitecountscript="/home/hub_oudenaarden/jyeung/projects/scchic-functions/scripts/motevo_scripts/lib/calculate_sitecount.py"
...
while [[ `qstat | grep MOTEVO | wc -l` > 0 ]]; do
