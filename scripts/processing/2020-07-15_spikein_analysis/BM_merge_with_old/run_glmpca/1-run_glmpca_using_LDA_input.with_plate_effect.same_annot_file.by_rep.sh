...
# bincutoff=5000
bincutoff=0
binskeepvec="0 500 1000"
# binskeep=0
# niter=500
nitervec="500 1000"

outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/glmpca_outputs/same_annot_file_rerun.byrep"
...
annotdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/cell_cluster_tables.spikeins_mouse.BMround2_umaps_and_ratios.Round1Round2.redo_after_varfilt_with_spikeins.2020-12-22.umap_spread.H3K27me3_cleaned"
...
for binskeep in $binskeepvec; do
    for niter in $nitervec; do
        ...
        for jmark in $jmarks; do
            ...
            annotname="cell_cluster_table_with_spikeins.${jmark}.2020-12-23.umap_spread.final.txt"
