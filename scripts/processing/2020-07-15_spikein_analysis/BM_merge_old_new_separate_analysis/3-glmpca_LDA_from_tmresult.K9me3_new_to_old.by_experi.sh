...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/glmpca_outputs/BM_from_projections"
...
annotdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BMround2.from_peaks.sitecount_mat.split_old_and_new/add_experi"
...
for binskeep in $binskeepvec; do
    for niter in $nitervec; do
        ...
        for jmark in $jmarks; do
            ...
            infpeaks="${indirpeaks}/$fnamepeaks"
            ...
            annotname="count_mat_from_sitecount_mat.${jmark}.filtNAcells_allbins.from_same_annot_file.metadata.2020-12-28.with_experi.txt"
