...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/count_tables_all_four_marks_dynamic_bins.top_6085"
outdir="$indir/merged_by_mark.top_6085"
[[ ! -d $outdir ]] && mkdir $outdir
# indirbed="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.dynamic_bins_TSS_TES_regions"
indirbed="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/DE_downstream_analysis_BM_allmerged_H3K27me3_cleaned"
...
for mark in $marks; do
    ...
    bedfnames="DE_bins_all_marks_top_6085_dists_to_TSS.annot_table.${mark}.2021-02-15.txt"
