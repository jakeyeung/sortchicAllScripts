...
# indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/count_tables_all_four_marks_dynamic_bins/merged_by_mark"
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/count_tables_all_four_marks_dynamic_bins.top_6085/merged_by_mark.top_6085"
...
prefix="mouse_spikein_BM.varfilt.dynamic_bins_genes.top_6085"
...
# for inf in `ls -d $indir/*.celltype_specific_genes.TSS_10kb.txt.rds`; do
