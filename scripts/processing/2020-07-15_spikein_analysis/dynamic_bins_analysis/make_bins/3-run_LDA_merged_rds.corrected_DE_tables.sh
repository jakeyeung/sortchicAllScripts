...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/count_tables_all_four_marks_dynamic_bins.corrected_DE_tables/merged_by_mark"
...
prefix="mouse_spikein_BM.varfilt.dynamic_bins_genes.corrected_DE_tables"
...
for inf in `ls -d $indir/*.corrected_DE_tables.rds`; do
