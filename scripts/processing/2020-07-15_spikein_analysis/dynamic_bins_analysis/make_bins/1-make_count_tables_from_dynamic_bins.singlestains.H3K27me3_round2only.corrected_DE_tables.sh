...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/count_tables_all_four_marks_dynamic_bins.corrected_DE_tables"
[[ ! -d $outdir ]] && mkdir -p $outdir

bedfnames="dynamic_bins.50kb.corrected_DE_tables.H3K27me3.2021-04-07.txt"
...
for mark in ${marks}; do
    for bedfname in $bedfnames; do
        ...
        for inbam in `ls -d ${bamdir}/PZ*${mark}*.bam`; do
            ...
            bname=${bname}
            outftab=${outdir}/${bname}.${bedname}.corrected_DE_tables.txt
