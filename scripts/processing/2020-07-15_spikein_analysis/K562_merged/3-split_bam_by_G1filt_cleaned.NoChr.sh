...
annotdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/cell_cluster_tables.K562_clean_by_G1filt"
...
outdir="$indir/bams_G1filt_split_by_G1filt_NoChrPrefix"
...
for jmark in $jmarks; do
    ...
    bname="K562_AllMerged_${jmark}.merged.sorted.tagged"
    inf=${indir}/${bname}.bam
