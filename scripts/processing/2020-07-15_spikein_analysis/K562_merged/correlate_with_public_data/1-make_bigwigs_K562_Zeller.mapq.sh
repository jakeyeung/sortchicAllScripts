...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/K562_tech_rep_merged/bigwigs_G1filt_split_by_G1filt.for_chipseq_comparison.mapq_${mapq}"
...
for mark in $marks; do
    ...
    fname=${fbase}.bam
    inbam=${indir}/${fname}
    outbw=${outdir}/${fbase}.bsize_${bsize}.mapq_${mapq}.bw
