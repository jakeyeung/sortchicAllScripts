...
inf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/K562_tech_rep_merged/compare_with_chipseq_K562/multibigwigsummary.log2inputs.${jdist}/K562_chipseq_vs_chic_comparison.npz"
...
for jmeth in $jmeths; do
    for jtype in $jtypes; do
        ...
        outf="${outdir}/K562_chipseq_vs_chic_comparison.correlation.jmeth_${jmeth}.jtype_${jtype}.${jdist}.log2inputs.pdf"
