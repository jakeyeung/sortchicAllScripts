...
outbase="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/K562_tech_rep_merged/compare_with_chipseq_K562/multibigwigsummary.log2inputs.${jdist}.TSS_TES"
...
outprefix="${outbase}/K562_chipseq_vs_chic_comparison.dist_${jdist}.TSS_TES"
outf=${outprefix}.npz
