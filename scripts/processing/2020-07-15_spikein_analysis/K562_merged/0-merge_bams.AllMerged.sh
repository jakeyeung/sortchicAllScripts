...
indir2="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/VAN5039_K562_round2/tagged_bams/cellcycle_sorted/merged_bams"
indir3="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/VAN5039_K562_round2/tagged_bams/G1_sorted/merged_bams"

[[ ! -d $indir1 ]] && echo "$indir1 not found, exiting" && exit 1
[[ ! -d $indir2 ]] && echo "$indir2 not found, exiting" && exit 1
[[ ! -d $indir3 ]] && echo "$indir3 not found, exiting" && exit 1
