...
outdir="${indir}/count_tables_${gtype}.CTCF_bl"
...
# inbed="/hpc/hub_oudenaarden/jyeung/data/databases/refseq/MmRefseqTss.chromorenamed.50000.bed"
inbed="/hpc/hub_oudenaarden/jyeung/data/databases/refseq/MmRefseqTss.chromorenamed.50000.again.bed"
# bl="/hpc/hub_oudenaarden/jyeung/data/databases/blacklists/mm10.blacklist.copy.sorted.merged.bed"
bl="/hpc/hub_oudenaarden/jyeung/data/databases/blacklists/mm10.blacklist.copy.sorted.merged.cat_with_CTCF_motifs.bed"
...
for inbam in `ls -d $indir/*.bam`; do
    ...
    outf=${outdir}/${bname}.count_tables_${gtype}.csv
