...
bedfile="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/regions_H3K4me1_H3K9me3_dynamic_regions/TES_genomewide.2021-02-11.txt"
...
for mark in ${marks}; do
    for inbam in `ls -d ${bamdir}/PZ-BM-rep3-*${mark}-*.bam`; do
        ...
        bname=${bname}
        outftab=${outdir}/${bname}.count_table_TES_genomewide.txt
