...
# bedfile="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/regions_H3K4me1_H3K9me3_dynamic_regions/H3K4me1_H3K9me3_celltype_specific_genes_and_bins_from_heatmap.2021-01-30.txt"
bedfile="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/regions_H3K4me1_H3K9me3_dynamic_regions/H3K4me1_H3K9me3_50kb_genomewide.2021-01-30.txt"

# outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BM_H3K4me1-H3K9me3_tech_rep_merged/raw_demultiplexed/count_tables_from_H3K4me1_H3K9me3_dynamic_genes_and_bins_from_heatmap"
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data_spikeins/BM_H3K4me1-H3K9me3_tech_rep_merged/raw_demultiplexed/count_tables_from_H3K4me1_H3K9me3_50kb_genomewide"
...
for mark in ${marks}; do
    for inbam in `ls -d ${bamdir}/BM_round1_round2_merged_*${mark}*.bam`; do
        ...
        bname=${bname}
        # outftab=${outdir}/${bname}.count_table_k4_k9_dynamic_bins_from_heatmap.txt
        outftab=${outdir}/${bname}.count_table_k4_k9_50kb_genomewide.txt
