...
# indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions"
# indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_TES_genomewide"
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions/mat_K4_regions_only"
...
jsuffix="k4_genes_only"
prefix="mouse_spikein_BM_dbl_reseq.varfilt.${jsuffix}"
...
for inf in `ls -d $indir/*${jsuffix}.2021-02-18.rds`; do
