...
# suffix="k4_k9_dynamic_regions.from_heatmap"
# suffix2="VarFilt_pass2_autosomesOnly.maxcountsfilt"
# experi="mouse_spikein_BMround2all.dbl_common_rows.cellfilt_binfilt"
jdate="2021-01-31"
suffix2="50kb_genomewide"
suffix="k4_k9_${suffix2}"
prefix="ClusterAnnot.lda_and_datmerged.${suffix}"
...
inmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions/lda_and_clusters.${suffix2}"
...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions/scchix_inputs.${suffix2}"
