...
ldadir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions/lda_and_clusters"
...
inputdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions/scchix_inputs"
outputdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions/scchix_outputs"
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions/scchix_outputs_downstream"
[[ ! -d $outdir ]] && mkdir -p $outdir

# outdir="${dblmain}/double_staining_output_downstream/${experi}_${suffix}/MF_BM_${experi}_${suffix}_${mark1}-${mark2}_split_reads"
# outdir="${dblmain}jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions/scchix_outputs_downstream"
# outdir=
...
unmixingname="scchix_inputs_clstr_by_celltype_H3K4me1xH3K9me3.removeNA_FALSE"
...
inflda1="${ldadir}/ClusterAnnot.lda_and_datmerged.k4_k9_dynamic_regions.${mark1}.2021-01-30.RData"
inflda2="${ldadir}/ClusterAnnot.lda_and_datmerged.k4_k9_dynamic_regions.${mark2}.2021-01-30.RData"
infldadbl="${ldadir}/ClusterAnnot.lda_and_datmerged.k4_k9_dynamic_regions.${markdbl}.2021-01-30.RData"
