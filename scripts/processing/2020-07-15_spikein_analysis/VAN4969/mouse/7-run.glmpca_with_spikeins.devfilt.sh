...
inspike="${prefix}/jyeung/data/scChiC/from_rstudioserver/quality_control_count_tables_mouse_for_lda/H3K4me3_BM.spikeins.txt"

outdir="${prefix}/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/glmpcaPois_mouse_spikein"

[[ ! -d $outdir ]] && mkdir $outdir

jpenalty=5

inf="${prefix}/jyeung/data/scChiC/from_rstudioserver/quality_control_count_tables_mouse_for_lda/H3K4me3_BM.dev_filt.rds"
bname=$(basename $inf)
bname=${bname%.*}
