...
infasta="/hpc/hub_oudenaarden/group_references/ensembl/97/mus_musculus/primary_assembly_NOMASK_ERCC92.WithLambdaPhage.fa"

BNAME="/hpc/hub_oudenaarden/jyeung/data/scChiC/spikein/fastqs/nohupsout/BwaIndex.mouse.out"
DBASE=$(dirname "${BNAME}")
