...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/cleaned_count_tables_for_lda_and_projections/merged_tables"
...
prefix="K562_spikein_integrate_with_old.all.merged_tables"
...
for inf in `ls -d $indir/*.merged.rds`; do
