...
bcmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/barcode_summaries_BM_build95-B6/summarized"

[[ ! -e $jscript ]] && echo "$jscript not found, exiting" && exit 1

outmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/bam_split_by_bc/count_thres-0_build95-B6.withchr"
