...
inmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/K562_Kaya-Okur/H3K27me3/dedup_beds"  # .bed.gz files
[[ ! -d $inmain ]] && echo "$inmain not found, exiting" && exit 1

jsuffix="hiddendomains"
inmain2="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/K562_Kaya-Okur/H3K27me3/Kaya-Okur_vs_${jsuffix}_peaks_filtered_dedup"
[[ ! -d $inmain2 ]] && echo "$inmain2 not found, exiting" && exit 1

outmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/K562_Kaya-Okur/H3K27me3/count_before_after_filtering_${jsuffix}_filt_dedup"
[[ ! -d $outmain ]] && mkdir $outmain

for infile in `ls -d $inmain/*.bed`; do
    fname=$(basename $infile)
    fname=${fname%.*}
    infilefilt=${inmain2}/${fname}.${jsuffix}_filt.bed
