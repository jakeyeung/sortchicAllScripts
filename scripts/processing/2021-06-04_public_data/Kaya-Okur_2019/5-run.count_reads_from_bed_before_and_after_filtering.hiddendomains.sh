...
inmain2="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/K562_Kaya-Okur/H3K27me3/Kaya-Okur_vs_${jsuffix}_peaks_filtered"
[[ ! -d $inmain2 ]] && echo "$inmain2 not found, exiting" && exit 1

outmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/K562_Kaya-Okur/H3K27me3/count_before_after_filtering_${jsuffix}_filt"
