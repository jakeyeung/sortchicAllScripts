...
# refbed="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/K562_Kaya-Okur/${jmark}/merged_beds/hiddendomains_output/K562_${jmark}_20181120_allmerged.1000.cutoff/K562_${jmark}_20181120_allmerged.1000.cutoff_analysis.invalid_records_filt.bed"
refbed="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/K562_Kaya-Okur/${jmark}/merged_beds_dedup/hiddendomains_output/K562_${jmark}_20181120_allmerged_dedup.1000.cutoff/K562_${jmark}_20181120_allmerged_dedup.1000.cutoff_analysis.invalid_records_filt.bed"
[[ ! -e $refbed ]] && echo "$refbed not found, exiting" && exit 1

inmain="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/K562_Kaya-Okur/${jmark}/dedup_beds"
...
outdir="${outmain}/Kaya-Okur_vs_hiddendomains_peaks_filtered_dedup"
[[ ! -d $outdir ]] && mkdir $outdir

for beda in `ls -d $inmain/*.bed`; do
