...
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/Wu_et_al_2021/SRA_data/prefetch_outputs"
# outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/public_data/Bartosovic_et_al_2021/SRA_data/prefetch_outputs/fastqs"
outdir="$indir/fastqs_check"
...
for d in `ls -d $indir/SRR*`; do
    ...
    cmd="fastq-dump --gzip --outdir ${outdir} --split-files $inf"
    echo $cmd
