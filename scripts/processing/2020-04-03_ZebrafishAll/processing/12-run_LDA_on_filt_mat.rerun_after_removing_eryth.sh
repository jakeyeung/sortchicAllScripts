...
prefix="ZF_AllMerged.winsize_${winsize}.remove_eryth"
...
indir="/hpc/hub_oudenaarden/jyeung/data/zebrafish_scchic/from_rstudio/count_tables.winsize_50000.chromo_filtered_by_counts_TAfrac_var.corrfilt.eryth_removed"
