...
jsuffix="lessstringent.remove_eryth"
prefix="ZF_AllMerged.winsize_${winsize}.imputevarfilt.${jsuffix}"
indir="/hpc/hub_oudenaarden/jyeung/data/zebrafish_scchic/from_rstudio/impute_var_filt_from.${jsuffix}"
