...
inscript="/home/hub_oudenaarden/jyeung/projects/scchic-functions/scripts/motevo_scripts/lib/annotate_bed_to_gene_and_distance.Zebrafish.R"  # new location, loads scchicFuncs
...
for mark in $marks; do
    ...
    jbase="merged.${mark}.minlength_${jlength}.cutoff_analysis.merged.withchr"
    inname=${jbase}.bed
