...
refdir="/hpc/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/bedannotations/${prefix}${jsuffix}"
[[ ! -d $refdir ]] && echo "$refdir not found, exiting" && exit 1

# dirsuffix=".Downsamp"
dirsuffix=".MillionBinCuts"
# dirsuffix=".MillionTSSCuts"
...
for jmark in $jmarks; do
    for dist in $dists; do
        ...
        indir="/hpc/hub_oudenaarden/jyeung/data/zebrafish_scchic/bigwigs_all/ZebrafishWKM.bigwigs_by_fewerclusters.mapq_40.bsize_100.2020-06-17.offset.r1only${dirsuffix}"
        ...
        outdir="/hpc/hub_oudenaarden/jyeung/data/zebrafish_scchic/deeptoolsout/ZebrafishWKM.deeptools_outputs.2020-06-17.offset.${jsuffix}.r1only${dirsuffix}"
        ...
        infsinput="${indir}/PZ-ChIC-ZF_${jmark}_2020-04-07.HSPCs.sorted.cleaned.${bsizeout}.DefaultNorm${dirsuffix}.bw ${indir}/PZ-ChIC-ZF_${jmark}_2020-04-07.lymph.sorted.cleaned.${bsizeout}.DefaultNorm${dirsuffix}.bw ${indir}/PZ-ChIC-ZF_${jmark}_2020-04-07.granu.sorted.cleaned.${bsizeout}.DefaultNorm${dirsuffix}.bw ${indir}/PZ-ChIC-ZF_${jmark}_2020-04-07.eryth.sorted.cleaned.${bsizeout}.DefaultNorm${dirsuffix}.bw"
