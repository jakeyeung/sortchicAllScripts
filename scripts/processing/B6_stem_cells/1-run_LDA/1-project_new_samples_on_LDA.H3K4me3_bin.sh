...
outf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisBins_PZ-Bl6-BM-Linneg/project_from_trained_LDA/bin_TRUE_PZ-Bl6-BM-Linneg_H3K4me3_binfilt_cellfilt.from_louvain.RData"

Rscript $rs --binarizemat $inlda $inmat $outf
