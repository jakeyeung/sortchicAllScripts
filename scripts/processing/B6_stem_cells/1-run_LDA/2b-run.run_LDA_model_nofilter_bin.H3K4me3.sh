...
prefix="PZ-Bl6-BM-StemCells_part2"
...
for mark in $marks; do
    for inf in `ls -d $indir/PZ*${mark}*.RData`; do
        outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisBins_${mindist}/lda_outputs.nonenriched_enriched_merged2.binarize.${binarize}.no_filt"
