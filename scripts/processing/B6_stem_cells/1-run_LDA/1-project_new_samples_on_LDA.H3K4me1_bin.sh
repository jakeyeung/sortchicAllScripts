...
outf="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisBins_PZ-Bl6-BM-Linneg/project_from_trained_LDA/bin_TRUE_PZ-Bl6-BM-Linneg_${jmark}_binfilt_cellfilt.from_louvain.RData"
