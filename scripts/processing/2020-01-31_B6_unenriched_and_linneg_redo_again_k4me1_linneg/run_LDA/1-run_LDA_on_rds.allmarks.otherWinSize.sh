...
prefix="B6BM_All_allmarks.2019-12-30.bsizestepsize_${bsize}"

# indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_B6.2019-12-16"
indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data/ZellerRawDataB6_redo_2019-12-13.tagged_bams_mergedbymarks/countTables_otherWinSize/qc_filt/qc_${bsize}"
...
for inf in `ls -d $indir/count_mat.H3K*me3*.rds`; do
