...
prefix="B6BM_All_allmarks.2020-01-31.var_filt_keepPlates"

indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_postLDA_var_BM_includeNewLinnegH3K4me1.2020-01-31"
...
for inf in `ls -d $indir/*.2020-02-04.Unenriched.WithLinneg.rds`; do
