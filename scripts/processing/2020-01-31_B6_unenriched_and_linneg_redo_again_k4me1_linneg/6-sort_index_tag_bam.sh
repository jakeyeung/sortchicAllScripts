...
# sleep 11000
# echo "sleepnig for 3 hours"

# WRAP UP
while [[ `qstat | grep "mapping" |  wc -l` > 0 ]]; do
...
outdir="/hpc/hub_oudenaarden/jyeung/data/scChiC/raw_data/ZellerRawData_B6_linneg_K4me1.tagged_bams"
