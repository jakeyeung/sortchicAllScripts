...
for inbam in `ls -d $inmain/*tagged.bam`; do
    ...
    outbam=$outdir/${bname}.retagged.bam
    ...
    . /hpc/hub_oudenaarden/jyeung/software/anaconda3/etc/profile.d/conda.sh; conda activate py3; cd $outdir; bamtagmultiome.py -method chic -o $outbam -mem 32 -time 3 $inbam  # Get K9me3
