...
prefix="B6BM_All_allmarks"

indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_macbook/count_mat_binfilt_cellfilt_for_LDA_PZ-Bl6-BM-All_allmarks"
...
for inf in `ls -d $indir/PZ-Bl6-BM-All_*H3K4me3*.rds`; do
