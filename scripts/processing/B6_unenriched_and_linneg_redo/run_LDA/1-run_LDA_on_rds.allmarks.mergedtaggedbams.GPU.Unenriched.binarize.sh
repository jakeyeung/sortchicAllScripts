...
#indir="/hpc/hub_oudenaarden/jyeung/data/scChiC/from_macbook/count_mat_binfilt_cellfilt_for_LDA_PZ-Bl6BM_FromMergedTaggedBams/quality_control_PZ_Bl6-BM-Linneg-Stemcells_AllMergedi"
...
for inf in `ls -d $indir/*H3K4me3*_Unenriched_*.rds`; do
    ...
    cd $workdir; . /hpc/hub_oudenaarden/jyeung/software/anaconda3/etc/profile.d/conda.sh; conda activate R3.6; Rscript $rs $inf $outdir --topics $topics --projname $bname --binarize $binarize
done
wait
