...
for (jmark in jmarks){
  ...
  dat.umap$mark <- paste(jmark, dat.umap$cond, sep = "_")
  dat.umap <- subset(dat.umap, select = c(cell, mark, umap1, umap2, louvain, plate, cond))
  
  cbPalette <- c("#696969", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#006400", "#FFB6C1", "#32CD32", "#0b1b7f", "#ff9f7d", "#eb9d01", "#7fbedf")
  
  outpdf <- file.path(outdir, paste0("AllMerged_with_blood.", jmarklong, ".pdf"))
  outtxt <- file.path(outdir, paste0("AllMerged_with_blood.", jmarklong, ".txt"))
  
  fwrite(dat.umap, file = outtxt, sep = "\t")
