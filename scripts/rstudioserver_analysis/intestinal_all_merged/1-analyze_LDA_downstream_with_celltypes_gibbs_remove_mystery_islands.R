...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/intestinal_all_merged/1-analyze_LDA_downstream_with_celltypes_gibbs_remove_mystery_islands.R
# 
...
# inmain <- paste0("/home/jyeung/hpc/intestinal_scchic/LDA_outputs/topicmodels/ldaAnalysisBins_intestines.2020-01-11.10000_5000")
inmain <- paste0("/home/jyeung/hpc/intestinal_scchic/LDA_outputs/topicmodels/ldaAnalysisBins_intestines.2020-01-13.filter_immune_cells.50000_25000")
infs <- list.files(inmain, pattern = ".Robj", recursive = TRUE, all.files = TRUE, full.names = TRUE)

outmain <- paste0("/home/jyeung/hpc/intestinal_scchic/from_rstudioiserver/pdfs/LDA_downstream_gibbs_withLouvain.RemoveMysteryIslands.", Sys.Date())
dir.create(outmain)
