...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/DE_analysis/1-run_DE_analysis_bins.four_marks.HSPC-vs_nonHSPC.R
# 
...
for (jmark in jmarks){
  outf <- file.path(outdir, paste0("poisson_fit_", jtype, ".",  jmark, ".", Sys.Date(), ".newannot2.witherrors.MoreBins.total.RData"))
  if (file.exists(outf)){
    next
  }
