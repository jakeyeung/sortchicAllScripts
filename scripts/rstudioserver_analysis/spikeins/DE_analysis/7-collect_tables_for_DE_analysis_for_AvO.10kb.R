...
for (jmark in jmarks){
  print(jmark)
  fname1 <- paste0("raw_cuts_pseudobulk_10kb_bins.new_batch_only.", jmark, ".txt")
  fname2 <- paste0("spikeinnorm_cuts_pseudobulk_10kb_bins.new_batch_only.", jmark, ".txt")
