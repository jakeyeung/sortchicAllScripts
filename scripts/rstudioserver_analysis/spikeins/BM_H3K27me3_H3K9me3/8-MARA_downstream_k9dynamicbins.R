...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/BM_H3K27me3_H3K9me3/8-MARA_downstream_k9dynamicbins.R
# 
...
fname <- paste0("MARA_output_BM_k9dynamicbinsfilt.", jmark, ".pdf")
