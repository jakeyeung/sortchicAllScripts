...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/BM_H3K27me3_H3K9me3/1-get_H3K9me3_celltype_bins.R
# 
...
jtopics.lst <- list("topic6" = "Bcells",
                    "topic30" = "Eryths",
                    "topic14" = "HSPCs",
                    "topic17" = "Granulocytes")
...
# order bins
ctypes.bins <- c("Eryths", "Bcells", "Granulocytes", "HSPCs"); names(ctypes.bins) <- ctypes.bins
