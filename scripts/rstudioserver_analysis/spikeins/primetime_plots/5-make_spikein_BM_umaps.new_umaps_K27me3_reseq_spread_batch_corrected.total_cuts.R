...
outpdf <- file.path(outdir, paste0("bone_marrow_hist_mod_differences.", Sys.Date(), ".normtorep3.same_annot_file.K27me3reseq.spread.batch_corrected.totalcuts.pdf"))
outrds <- file.path(outdir, paste0("bone_marrow_hist_mod_differences.", Sys.Date(), ".normtorep3.same_annot_file.K27me3reseq.spread.batch_corrected.totalcuts.rds"))
...
its.ds.lst.bymark$H3K4me1$jfits.ds.lst$jfit
...
dat.totalcuts <- data.frame(cell = colnames(bin.mat), totalcuts = colSums(bin.mat), stringsAsFactors = FALSE) %>%
