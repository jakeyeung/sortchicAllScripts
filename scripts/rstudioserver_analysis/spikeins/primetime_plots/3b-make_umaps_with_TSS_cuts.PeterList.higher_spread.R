# Jake Yeung
# Date of Creation: 2020-12-24
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/primetime_plots/3b-make_umaps_with_TSS_cuts.PeterList.higher_spread.R
# 
...
pdfout <- file.path(outdir, paste0("famous_genes_on_umap_raw_cuts.ListFromHeatmap.higher_spread.with_mat_adj.", Sys.Date() , ".pdf"))
