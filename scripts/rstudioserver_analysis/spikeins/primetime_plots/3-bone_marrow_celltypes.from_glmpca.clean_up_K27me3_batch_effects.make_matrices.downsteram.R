...
outpdf <- file.path(outdir, paste0("bonemarrow_heatmaps_3_marks_TSS_pretty.", Sys.Date(), ".cexsmall.pdf"))

pdf(outpdf, useDingbats = FALSE)

for (jmark.test in jmarks){
  outrdata.tmp <- file.path(outdir, paste0("heatmap_ordered_with_labels.", jmark.test, ".RData"))
  print(jmark.test)
