...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/mouse/run_LDA_downstream.R
# Explore LDA downstream
...
outdir <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/spikeins_mouse.round2/suffix", jsuffix)
dir.create(outdir)
