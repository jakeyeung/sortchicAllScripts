...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/mouse/get_good_cells.R
# 
...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_count_tables_mouse_for_lda.chromo2spikeinfilt.VAN5046"
dir.create(outdir)
