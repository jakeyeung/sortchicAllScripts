...
pdfout <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/H3K4me1_H3K9me3_differential_expression_outputs/differential_expression_output_H3K4me1_H3K9me3.pdf"
...
ggplot(params.dat.merge %>% filter(estimate2 > -5), aes(x = estimate1, y = estimate2)) + 
  ...
  xlab("H3K9me3 log2FC relative to HSPC") + 
  geom_density_2d() + 
  theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank())
