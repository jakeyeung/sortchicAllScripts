...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/BM_H3K4me1-H3K9me3_reseq/1-analyze_K4me1_K9me3_and_dbl.more_bins.R
# Use all bins 
...
infs.cuts <- list.files(indir.cuts, pattern = ".*.binsize_50000.csv", full.names = TRUE)
...
outf <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.H3K4me1_H3K9me3.reseq/metadata.H3K4me1_H3K9me3.txt"
fwrite(dat.meta.merge3, outf)
