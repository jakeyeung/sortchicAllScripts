...
# ggplot(subset(dat.metas$H3K4me1, cell %in% colnames(count.mat.lst$H3K4me1)), aes(x = umap1, y = umap2, color = batch)) + 
#   geom_point() + 
#   theme_bw() + 
#   theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank())
# 
# ggplot(subset(dat.metas$H3K9me3, cell %in% colnames(count.mat.lst$H3K9me3)), aes(x = umap1, y = umap2, color = batch)) + 
#   geom_point() + 
#   theme_bw() + 
#   theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank())
...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions/from_k9dynamicregions.RemoveHSPCs"
dir.create(outdir)

for (jname in jnames){
  print(jname)
  fname <- paste0("count_name.", jname, ".k4_k9_dynamic_bins.RemoveHSPCs", Sys.Date(), ".rds")
