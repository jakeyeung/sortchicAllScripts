...
jdate <- "2021-01-30"
# jmark <- "H3K4me1"
indir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/ldaAnalysisBins_mouse_spikein_BM_dbl_reseq.varfilt.k4_k9_dynamic_bins_from_heatmap"

outs.lst <- lapply(jmarks.withdbl, function(jmark){
  print(jmark)
  dname <- paste0("lda_outputs.count_name.", jmark, ".k4_k9_dynamic_bins_from_heatmap.", jdate, ".K-30.binarize.FALSE/ldaOut.count_name.", jmark, ".k4_k9_dynamic_bins_from_heatmap.", jdate, ".K-30.Robj")
...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BM.k4_k9_dynamic_regions/lda_and_clusters.from_heatmap"
dir.create(outdir)
for (jmark in jmarks.withdbl){
  print(jmark)
  jmarkout <- ifelse(jmark == "H3K4me1-H3K9me3", "H3K4me1xH3K9me3", jmark)
  fnameout <- paste0("ClusterAnnot.lda_and_datmerged.k4_k9_dynamic_regions.from_heatmap.", jmarkout, ".", Sys.Date(), ".RData")
