...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/BM_H3K4me1-H3K9me3_reseq/13-UMAP_gene_regions.R
# Plot UMAP of interesting regions? 
...
outpdf <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/primetime2/H3K9me3_analysis/umap_gene_sets.", Sys.Date(), ".again.pdf")
