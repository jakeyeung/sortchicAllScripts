...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/BM_H3K4me1-H3K9me3_reseq/3-run_DE_analysis_bins.more.all_marks.spikeins.pseudotime.R
# description
rm(list=ls())
...
for (jmark in jmarks){
  outf <- file.path(outdir, paste0("poisson_fit_", jtype, ".",  jmark, ".", Sys.Date(), ".newannot2.witherrors.MoreBins.newestmeta.spikeins.pseudotime.RData"))
  if (file.exists(outf)){
