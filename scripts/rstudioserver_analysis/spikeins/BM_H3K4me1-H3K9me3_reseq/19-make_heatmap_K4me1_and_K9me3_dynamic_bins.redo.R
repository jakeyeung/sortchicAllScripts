...
inf <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/robjs_H3K4me1_H3K9me3_analysis/batch_corrected_imputed_values.bins.all_marks.mat.namesfix.2021-02-06.H3K4me1_H3K9me3.TES_50kb_together.dedup.again2.RData"
load(inf, v=T)
...
jmat.wins.lst <- lapply(jmarks, function(jmark){
  jmat <- mat.adj.lst[[jmark]][, cells.keep.lst[[jmark]]]
...
pdf(file = paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/heatmaps/H3K4me1_H3K9me3_dynamic_bins_heatmaps.", Sys.Date(), ".again.pdf"))
