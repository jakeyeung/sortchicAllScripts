...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/dendrograms/5-downstream_make_plots_of_dynamic_bins.R
# 
...
out.lst <- GetPbulks(dat.metas, jmarks, jsuffixmain, merge.ctypes.by.lineage = FALSE, scale.factor = 10^6)
...
pdf(file.path(outdir, paste0("primetime_top_6085_features_and_heatmaps.pdf")), useDingbats = FALSE)
