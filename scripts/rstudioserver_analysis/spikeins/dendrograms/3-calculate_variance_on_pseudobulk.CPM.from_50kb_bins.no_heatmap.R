...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/dendrograms/3-calculate_variance_on_pseudobulk.CPM.from_50kb_bins.R
# 
...
outpdf <- file.path(outdir, paste0("variance_by_clusters_by_HighBins.", Sys.Date(), ".", jscale, ".log10filt_", log10filt, ".noheatmap.bootstraps.pdf"))
