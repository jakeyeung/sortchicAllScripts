...
outpdf <- file.path(outdir, paste0("variance_by_clusters_by_HighBins.", Sys.Date(), ".", jscale, ".log10filt_", log10filt, ".methods.check_other_norms.add_DE_bins.ward2.pdf"))
outrds <- file.path(outdir, paste0("variance_by_clusters_by_HighBins.", Sys.Date(), ".", jscale, ".log10filt_", log10filt, ".methods.check_other_norms.add_DE_bins.ward2.rds"))
