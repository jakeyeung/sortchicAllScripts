...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/spikeins_mouse.BMround2all.varfilt.blfix"
dir.create(outdir)
...
inmain <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/ldaAnalysisBins_mouse_spikein_BMround2all_varfilt.blfix")
# load(inf.lda, v=T)

# jsuffix <- ".varfilt_1.5.K-30"
jsuffix <- ".filt_0.15_0.95_counts_and_l2r.blfix.varfilt.K-30"
...
outrdata <- file.path(outdir, "LDA_downstream_objects.RData")
