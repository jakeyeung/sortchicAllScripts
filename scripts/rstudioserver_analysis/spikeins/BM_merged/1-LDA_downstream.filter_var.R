...
lowvar.filt <- 1.5
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_BM_round2_all/varfilt"
outpdf <- file.path(outdir, "plot_varfilt_UMAP_before_after.pdf")
