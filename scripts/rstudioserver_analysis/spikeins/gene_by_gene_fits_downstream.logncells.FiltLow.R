...
inf.chromo <- paste0("/home/jyeung/data/from_rstudioserver/spikein_fits/spikein_fits_bins.", jdate, ".NormByChromo.logncells.LowFilt_800.rds")

pdfout <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/spikeins/fits_gene_by_gene.", jdate, ".logncells.FiltLow.pdf")
