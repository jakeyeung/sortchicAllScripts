...
for (jmark in jmarks){
  ...
  inf.lda <- file.path(hubprefix, paste0("jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/ldaAnalysisBins_mouse_spikein_BMround2all_rep2rep3reseq_TES/lda_outputs.PZ-BM-rep3-H3K27me3-rep2rep3reseq.TES.varfilt.K-30.binarize.FALSE/ldaOut.PZ-BM-rep3-H3K27me3-rep2rep3reseq.TES.varfilt.K-30.Robj"))
  load(inf.lda, v=T)
  ...
  # Ssave outputs -----------------------------------------------------------
  outf <- file.path(outdir, paste0("poisson_fit_TES.",  jmark, ".", Sys.Date(), ".newannot2.rep2_rep3seq.RData"))
