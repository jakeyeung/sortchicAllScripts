...
for (jmark in jmarks){
  ...
  outpdf <- file.path(outdir, paste0("LDA_GLMPCA_LSI_downstream.", jmark, ".", jsuffix, ".", jtopn, ".", jminibatch, ".", jmethod, ".pdf"))
  ...
  if (!allmerged){
    inf.glmpca <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/glmpcaPois_K562_spikein.round2.genes_filt/K562_count_tables_50000.", jmark, ".", jsuffix, ".topn_", jtopn, ".glmpcaout.penalty_1.maxiter_10000.", jminibatch, ".", jmethod, ".RData")
  } else {
    inf.glmpca <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/glmpcaPois_K562_spikein.round2.merged.genes_filt/K562_count_tables_50000.", jmark, ".", jsuffix, ".topn_", jtopn, ".glmpcaout.penalty_1.maxiter_10000.", jminibatch, ".", jmethod, ".RData")
  }
