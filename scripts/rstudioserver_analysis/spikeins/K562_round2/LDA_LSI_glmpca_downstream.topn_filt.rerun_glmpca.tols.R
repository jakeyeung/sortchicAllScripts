...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/K562_round2/LDA_LSI_glmpca_downstream.topn_filt.rerun_glmpca.tols.R
# description
...
for (jmark in jmarks){
  ...
  outpdf <- file.path(outdir, paste0("LDA_GLMPCA_LSI_downstream.", jmark, ".", jsuffix, ".", jtopn, ".", jminibatch, ".", jmethod, ".tol_", jtol, ".pdf"))
