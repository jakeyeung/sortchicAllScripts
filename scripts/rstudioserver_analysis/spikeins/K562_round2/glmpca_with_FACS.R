...
if (!allmerged){
  outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/spikeins_K562.round2.WithFACS"
} else {
  outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/spikeins_K562.round2.AllMerged.WithFACS"
}
dir.create(outdir)
...
#   jsub <- dat.glmpca.lst[[jmark]]
#   jfit <- lm(formula = log2(chromocounts / spikeincounts) ~ cellcycle.str, data = jsub)
...
outpdf <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/glmpca_spikeins_hoescht.K562_G1_G2/glmpca_spikeins_hoescht_summaries.K562_G1_G2.", Sys.Date(), ".pdf")
