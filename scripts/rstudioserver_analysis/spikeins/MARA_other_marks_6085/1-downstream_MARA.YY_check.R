...
zscores.cutoff <- 1.25
jsize <- 1.5
jsuffix <- ".NoYy2.fromnode"
outpdf <- file.path(outdir, paste0("H3K27me3_MARA_outputs.zscorecutoff_", zscores.cutoff, ".dotsize_", jsize, "." , Sys.Date(), jsuffix, ".pdf"))
