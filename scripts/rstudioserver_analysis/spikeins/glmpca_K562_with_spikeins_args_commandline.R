...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/glmpca_K562_with_spikeins_args_commandline.R
# 
...
parser$add_argument('-outspike', metavar='OUTFILE',
                    help='RData containing dat.spikeins.mat object')
parser$add_argument('-K', metavar='OUTFILE', type = 'int', default = 30, required=TRUE,
...
assertthat::assert_that(!file.exists(args$outspike))
...
# 
# outspike <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/quality_control_spikeins_K562/spikein_counts/spikein_counts_all.RData"
# save(dat.spikeins.mat, file = outspike)

load(args$outspike, verbose=TRUE)
