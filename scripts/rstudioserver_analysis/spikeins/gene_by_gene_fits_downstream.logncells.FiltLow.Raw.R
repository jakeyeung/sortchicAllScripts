...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/gene_by_gene_fits_downstream.logncells.FiltLow.Raw.R
# 
...
jdate <- "2020-07-24"
jdate2 <- "2020-08-10"
inf.spikein <- paste0("/home/jyeung/data/from_rstudioserver/spikein_fits/spikein_fits_bins.", jdate, ".logncells.FiltLow_800.rds")
inf.chromo <- paste0("/home/jyeung/data/from_rstudioserver/spikein_fits/spikein_fits_bins.", jdate2, ".NormByRaw.logncells.LowFilt_800.WithRnames.rds")
...
pdfout <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/spikeins/fits_gene_by_gene.", jdate2, ".logncells.FiltLow.CompareWithRaw.pdf")
...
# jmark <- "H3K4me3"
# 
# fits.merge <- left_join(fits.spikein[[jmark]] %>% dplyr::rename(slope.spikein = slope) %>% select(slope.spikein, mark, prep, spikeinconc), 
#                         fits.chromo[[jmark]] %>% dplyr::rename(slope.chromo = slope) %>% select(slope.chromo, mark, prep, spikeinconc))
# 
# plot(fits.spikein[[jmark]]$slope, fits.chromo[[jmark]])
# # plot()
