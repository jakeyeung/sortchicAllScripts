...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/BM_merged_with_old/8-differential_expression_analysis_downstream.spikeins.hiddendomains.R
# 
...
for (jmark in jmarks){
  ...
  inf.fits <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/poisson_fits_BM_AllMerged3.spikeins/poisson_fit_", jtype, ".", jmark, ".2020-11-13.spikeins.again.RData")
  load(inf.fits, v=T)
