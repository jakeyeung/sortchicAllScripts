...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/BM_merged_with_old/7-differential_expression_analysis_TSS_10kb.with_se.no_H3K27me3.spikeins.R
# 
...
for (jmark in jmarks){
  outf <- file.path(outdir, paste0("poisson_fit_TSS_", jdist, ".",  jmark, ".", Sys.Date(), ".spikeins.newannot2.RData"))
