...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/BM_merged_with_old/7-differential_expression_analysis_TSS.R
# 
...
for (jmark in jmarks){
  ...
  indir <- file.path(hubprefix, "jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/ldaAnalysisBins_mouse_spikein_BMround2all_MergeWithOld.from_TSS")
  
  fname <- paste0("lda_outputs.count_mat_from_TSS.", jmark, ".K-30.binarize.FALSE/ldaOut.count_mat_from_TSS.", jmark, ".K-30.Robj")
  ...
  # Ssave outputs -----------------------------------------------------------
  outf <- file.path(outdir, paste0("poisson_fit_TSS_", jdist, ".",  jmark, ".", Sys.Date(), ".RData"))
