...
outdir2 <- file.path(hubprefix, "jyeung/data/scChiC/from_rstudioserver/count_tables.BMround2.from_peaks.sitecount_mat/filtNAcells_allbins")
dir.create(outdir2)
...
for (jmark in jmarks){
  ...
  outf2 <- file.path(outdir2, paste0("count_mat_from_sitecount_mat.", jmark, ".filtNAcells_allbins.rds"))
