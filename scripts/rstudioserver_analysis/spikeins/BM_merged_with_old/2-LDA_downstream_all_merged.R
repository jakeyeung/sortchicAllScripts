...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/spikeins_mouse.BMround2all.merge_with_old"
dir.create(outdir)
...
jsuffix <- "count_mat_old_merged_with_new"
...
outs.lst <- lapply(jmarks, function(jmark){
  ...
  fname <- paste0("ldaOut.", jsuffix, ".", jmark, ".K-30.Robj")
