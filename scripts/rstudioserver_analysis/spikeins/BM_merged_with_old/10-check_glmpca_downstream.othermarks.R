...
# jsuffix <- "bincutoff_0.binskeep_500.byplate.szname_none.niter_500.reorder_rownames.dupfilt"
# jsuffix <- "bincutoff_0.binskeep_0.byplate.szname_none.niter_500.reorder_rownames.dupfilt"
jsuffix <- "bincutoff_0.binskeep_0.byplate.szname_none.reorder_rownames.dupfilt"

outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/glmpca_outputs_BM_AllMerged3_plate"
...
for (jmark in jmarks){
  ...
  outbase <- file.path(outdir, paste0("glmpca_plate_effects_output.", jmark, ".", jsuffix, ".", Sys.Date()))
  ...
  # fname <- paste0("glmpca.", jmark, ".bincutoff_0.binskeep_500.byplate.szname_none.reorder_rownames.notfromsitecounts.RData")
  ...
  dat.glmpca.annot <- left_join(dat.glmpca, subset(dat.annot, select = c(cell, cluster, plate, experi)))
  dat.lda.annot <- left_join(dat.lda, subset(dat.annot, select = c(cell, cluster, plate, experi)))
  ...
  multiplot(m.glmpca.plates, m.lda.plates, cols = 2)
  # saveoutput
