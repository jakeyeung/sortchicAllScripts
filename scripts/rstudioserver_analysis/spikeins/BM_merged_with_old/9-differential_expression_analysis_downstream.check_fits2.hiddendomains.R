...
for (jmark in jmarks){
  ...
  # jmark <- "H3K4me3"
  # jmark <- "H3K27me3"
  outf <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/differential_analysis_BM_AllMerged3.gene_examples/DE_downstream_", jtype, ".", jmark, ".with_examples.", Sys.Date(), ".pdf")
  if (file.exists(outf)){
    print(paste("outf exists", outf))
    next
  }
  ...
  # inf1 <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/poisson_fits_BM_AllMerged3/poisson_fit_TSS_10000.", jmark, ".2020-11-14.newannot2.RData")
  # inf2 <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/poisson_fits_BM_AllMerged3.spikeins/poisson_fit_TSS.dist_10000.", jmark, ".2020-11-14.spikeins.again.newannot2.RData")
  inf1 <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/poisson_fits_BM_AllMerged3/poisson_fit_", jtype, ".", jmark, ".2020-11-15.newannot2.RData")
  inf2 <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/poisson_fits_BM_AllMerged3.spikeins/poisson_fit_", jtype, ".", jmark, ".2020-11-15.spikeins.again.newannot2.RData")
