...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/count_tables.BMAllMerged2.from_peaks/filtNAcells_topbins"

lapply(jmarks, function(jmark){
  print(jmark)
  outf <- file.path(outdir, paste0("count_mat_from_hiddendomains.", jmark, ".filtNAcells_topbins.rds"))
