...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/spikeins/BM_merged_with_old/3-load_count_tables_fill_zeros_for_LDA.R
# 
...
outdir <- file.path(hubprefix, paste0("jyeung/data/scChiC/from_rstudioserver/count_tables.BMround2.", jsuffix))
dir.create(outdir)
...
for (jmark in jmarks){
  print(jmark)
  outf <- file.path(outdir, paste0("count_mat_", jsuffix, ".", jmark, ".rds"))
