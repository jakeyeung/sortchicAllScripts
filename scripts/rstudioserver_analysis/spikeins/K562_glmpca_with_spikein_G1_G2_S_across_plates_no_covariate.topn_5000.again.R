...
for (jmark in jmarks){
  ...
  m1 <- ggplot(dat.umap.lsi, aes(x = umap1, y = umap2, color = experi)) + geom_point() + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
    facet_wrap(~experi) + 
    ggtitle("LSI")
  print(m1)
  
  m2 <- ggplot(dat.umap.lsi, aes(x = umap1, y = umap2, color = log2(totalcounts / spikeincounts))) + geom_point() + 
    scale_color_viridis_c() + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("LSI")
  print(m2)
  
  m3 <- ggplot(dat.umap.lsi, aes(x = umap1, y = umap2, color = log2(totalcounts / spikeincounts))) + geom_point() + 
    scale_color_viridis_c() + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("LSI") + 
    facet_wrap(~experi)
  ...
  m4 <- ggplot(dat.umap.lsi, aes(x = experi, y = log2(totalcounts / spikeincounts))) + 
    geom_point() + 
    geom_boxplot() + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("LSI")
  ...
  m5 <- ggplot(dat.umap.lda, aes(x = umap1, y = umap2, color = experi)) + 
    geom_point() +
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    facet_wrap(~experi) + 
    ggtitle("LDA")
  ...
  m6 <- ggplot(dat.umap.lda, aes(x = umap1, y = umap2, color = experi)) + 
    geom_point() +
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("LDA")
  print(m6)
  
  m <- ggplot(dat.umap.lda, aes(x = umap1, y = umap2, color = log2(totalcounts / spikeincounts))) + 
    geom_point() +
    scale_color_viridis_c() + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("LDA")
  ...
  m <- ggplot(dat.umap.lda, aes(x = umap1, y = umap2, color = log10(totalcounts))) + 
    geom_point() +
    scale_color_viridis_c() + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("LDA")
  ...
  gpca.dat <- data.frame(dim1 = glmpcaout$factors$dim1, dim2 = glmpcaout$factors$dim2, cell = rownames(glmpcaout$factors), stringsAsFactors = FALSE)
  
  dat.umap.glmpca <- dat.umap.glmpca %>%
    left_join(., gpca.dat)
  
  
  m <- ggplot(dat.umap.glmpca, aes(x = umap1, y = umap2, color = experi)) + 
    geom_point() +
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    facet_wrap(~experi) + 
    ggtitle("GLMPCA")
  ...
  m <- ggplot(dat.umap.glmpca, aes(x = umap1, y = umap2, color = log2(totalcounts / spikeincounts))) + 
    geom_point() +
    scale_color_viridis_c() + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("GLMPCA")
  ...
  m <- ggplot(dat.umap.glmpca, aes(x = dim1, y = dim2, color = log2(totalcounts / spikeincounts))) + 
    geom_point() +
    scale_color_viridis_c() + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("GLMPCA")
  ...
  m <- ggplot(dat.umap.glmpca, aes(x = dim1, y = dim2, color = cellcycle.str)) + 
    geom_point() +
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("GLMPCA")
  print(m)
  ...
  m <- ggplot(dat.umap.glmpca, aes(x = dim1, y = dim2, color = log2(totalcounts / spikeincounts))) + 
    ...
    scale_color_viridis_c() + 
    ggtitle("GLMPCA") + 
    facet_wrap(~cellcycle.str, ncol = 1)
  print(m)
  ...
  m <- ggplot(dat.umap.glmpca, aes(x = dim1, y = dim2, color = log2(totalcounts))) + 
    geom_point() +
    scale_color_viridis_c() + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("GLMPCA")
  ...
  m <- ggplot(dat.umap.lda %>% left_join(., dat.var), aes(x = umap1, y = umap2, color = cell.var.within.sum.norm)) + 
    geom_point() +
  ...
  m <- ggplot(dat.umap.lsi %>% left_join(., dat.var), aes(x = umap1, y = umap2, color = cell.var.within.sum.norm)) + 
    geom_point() +
    scale_color_viridis_c(direction = -1) + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("LSI")
  ...
  m <- ggplot(dat.umap.glmpca %>% left_join(., dat.var), aes(x = umap1, y = umap2, color = cell.var.within.sum.norm)) + 
    geom_point() +
    scale_color_viridis_c(direction = -1) + 
    theme_bw() + theme(aspect.ratio=1, panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
    ggtitle("GLMPCA")
