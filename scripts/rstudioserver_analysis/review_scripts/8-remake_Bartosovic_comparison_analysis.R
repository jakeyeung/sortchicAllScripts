...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/review_scripts/8-remake_Bartosovic_comparison_analysis.R
...
dvec <- list("scCT/H3K27me3_cell_lines_1", "scCT/H3K27me3_cell_lines_2", "kaya_okur/H1_H3K27me3_iCell8", "kaya_okur/K562_H3K27me3_iCell8", "grosselin/SRR7536861", "grosselin/SRR7536860", "grosselin/SRR7536862")
...
outname <- paste0("frip_peakcounts_allcounts.", Sys.Date(), ".rds")
