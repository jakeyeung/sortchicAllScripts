...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/review_scripts/1-compare_reads_NBT_papers.R
# 
...
# save output
outrds <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/post_submission/K562_public_data/unique_reads_many_studies.2021-06-09.rds")
