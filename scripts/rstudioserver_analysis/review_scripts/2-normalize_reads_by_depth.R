...
outpdf <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/post_submission/K562_public_data/CUTnTAG_vs_Zeller_H3K27me3_dedup.", Sys.Date(), ".pdf")
