...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/WKM_and_BM_together/downstream_poisson_model_analysis_show_2D_cloud.ZF.R
# 
...
ctypes.end <- list("Clustergranu", "Clusterlymph", "Clustereryth"); names(ctypes.end) <- ctypes.end
...
infits.wrangled <- file.path(indir, paste0("fit_poisson_model_on_TSS_ZF.DownstreamWrangled.",jdate2, ".RData"))

pdfout <- file.path(indir, paste0("fit_poisson_model_on_TSS.Downstream2DClouds.ZF.", Sys.Date(), ".pdf"))
