...
infits <- file.path(indir, paste0("fit_poisson_model_on_TSS.", jdate, ".RData"))
outfits.wrangled <- file.path(outdir, paste0("fit_poisson_model_on_TSS.DownstreamWrangled.", Sys.Date(), ".RefitAgain.RData"))
outpdf <- file.path(outdir, paste0("fit_poisson_model_on_TSS.DownstreamWrangled.", Sys.Date(), ".RefitAgain.pdf"))
