...
# inf.ci <- "/home/jyeung/data/from_rstudioserver/poisson_fits/fit_poisson_model_on_TSS_ZF.DownstreamWrangled.2020-06-09.ClusterRenamed.ConfidenceIntervals.RData"
inf.ci <- "/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/poisson_fits/fit_poisson_model_on_TSS.DownstreamWrangled.2020-06-10.ConfidenceIntervals.smaller.RData"
outf.ci <- "/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/poisson_fits/fit_poisson_model_on_TSS.DownstreamWrangled.2020-06-10.ConfidenceIntervals.smaller.Wrangled.RData"
load(inf.ci, v=T)
