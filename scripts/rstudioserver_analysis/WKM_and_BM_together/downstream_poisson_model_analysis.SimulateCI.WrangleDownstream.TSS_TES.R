...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/WKM_and_BM_together/downstream_poisson_model_analysis.SimulateCI.WrangleDownstream.TSS_TES.R
# 
...
# inf.ci <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/poisson_fits.OtherNorm/fit_poisson_model_on_TSS.BM.NormMeth_", jnorm, ".CI.RData")
inf.ci <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/poisson_fits.OtherNorm.DiffDists.TSS_TES/fit_poisson_model_on_TSS.MouseBM.TSS_TES.CI.RData")

outf.ci <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/poisson_fits.OtherNorm.DiffDists.TSS_TES/fit_poisson_model_on_TSS.MouseBM.TSS_TES.CI.DownstreamWrangled.RData")
# outf.ci <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/poisson_fits.OtherNorm/fit_poisson_model_on_TSS.BM.NormMeth_", jnorm, ".CI.DownstreamWrangled.RData")

assertthat::assert_that(file.exists(inf.ci))
