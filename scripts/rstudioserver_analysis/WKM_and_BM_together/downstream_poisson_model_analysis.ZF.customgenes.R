...
outfits.wrangled <- file.path(indir, paste0("fit_poisson_model_on_TSS_ZF.DownstreamWrangled.", Sys.Date(), ".ClusterRenamed.RData"))
...
jfits.long.test.lst <- lapply(jfits.long.lst, function(jfits){
