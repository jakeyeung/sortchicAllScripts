...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/WKM_and_BM_together/downstream_poisson_model_analysis_show_2D_cloud.with_CI.TSS_TES.R
# 
...
fitsdir <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/poisson_fits.OtherNorm.DiffDists.TSS_TES")
jprefix <- "fit_poisson_model_on_TSS.MouseBM.TSS_TES"
...
infit.ci <- file.path(fitsdir, paste0(jprefix, ".CI.DownstreamWrangled.RData"))

outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/integrated_analysis_poisson_and_2D_clouds.TSS_TES"
dir.create(outdir)
...
for (jgene in jgenes){
  for (jmark in jmarks){
    ...
    ncuts.cells.mark <- ncuts.for.fit[[jmark]]
