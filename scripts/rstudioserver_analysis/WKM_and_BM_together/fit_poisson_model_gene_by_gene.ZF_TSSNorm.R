...
for (jdist in jdists){
  ...
  for (jnorm in jnorms){
    ...
    inf.offsets <- "/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/bins_tss_totalcuts.countsByCluster/zebrafish/ZebrafishWKMFromTopics.2000.bins_tss_hetero_and_totalcuts.celltable.txt"
