...
outdir <- file.path(hubprefix, "jyeung/data/scChiC/from_rstudioserver/H3K4me1_H3K9me3_analyses/cluster_tables.withdbl.cellfilt_binfilt")
dir.create(outdir)
jmark1 <- "H3K4me1"
jmark2 <- "H3K9me3"
...
lda.outs <- lapply(jmarks, function(jmark){
  print(jmark)
  inf <- file.path(hubprefix, paste0("jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/ldaAnalysisBins_mouse_spikein_BMround2all.dbl_common_rows.cellfilt_binfilt/lda_outputs.count_mat.", jmark, ".match_dbl.cellfilt.binfilt.K-30.binarize.FALSE/ldaOut.count_mat.", jmark, ".match_dbl.cellfilt.binfilt.K-30.Robj"))
...
# badlouvs <- c("louvain3", "louvain4", "louvain9", "")
badlouvs <- c("louvain4", "louvain9", "louvain7")
# louvskeep <- c("louvain1", "louvain6", "louvain2")
...
inf.markdbl <- file.path(hubprefix, paste0("jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/ldaAnalysisBins_mouse_spikein_BMround2all.dbl_common_rows.cellfilt_binfilt/lda_outputs.count_mat.", jmarkdbl, ".match_dbl.cellfilt.binfilt.K-30.binarize.FALSE/ldaOut.count_mat.", jmarkdbl, ".match_dbl.cellfilt.binfilt.K-30.Robj"))
