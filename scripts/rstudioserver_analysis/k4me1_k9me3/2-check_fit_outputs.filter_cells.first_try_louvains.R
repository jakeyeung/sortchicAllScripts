...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/k4me1_k9me3/2-check_fit_outputs.filter_cells.R
# 
...
projmain <- file.path(hubprefix, paste0("jyeung/data/scChiC/raw_data_spikeins/H3K4me1_H3K9me3_analysis/projects_after_unmixing.H3K4me1xH3K9me3/mouse_spikein_BMround2all.dbl_common_rows_match_dbl"))
...
inf.input <- file.path(hubprefix, "jyeung/data/scChiC/raw_data_spikeins/H3K4me1_H3K9me3_analysis/first_try/double_staining_input/mouse_spikein_BMround2all.dbl_common_rows_match_dbl/mouse_spikein_BMround2all.dbl_common_rows_match_dbl_clstr_by_louvain_H3K4me1xH3K9me3.removeNA_FALSE.RData")
...
inf.output <- file.path(hubprefix, "jyeung/data/scChiC/raw_data_spikeins/H3K4me1_H3K9me3_analysis/first_try/double_staining_output/mouse_spikein_BMround2all.dbl_common_rows_match_dbl/unmix_mouse_spikein_BMround2all.dbl_common_rows_match_dbl_clstr_by_louvain_H3K4me1xH3K9me3.removeNA_FALSE.RData")
...
# 
inf.annot.k9me3 <- file.path(hubprefix, "jyeung/data/scChiC/raw_data_spikeins/H3K4me1_H3K9me3_analysis/first_try/clustering_outputs.mouse_spikein_BMround2all.dbl_common_rows/LouvainAnnot.ldaOut.count_mat.H3K9me3.match_dbl.K-30.RData")
inf.annot.k4me1 <- file.path(hubprefix, "jyeung/data/scChiC/raw_data_spikeins/H3K4me1_H3K9me3_analysis/first_try/clustering_outputs.mouse_spikein_BMround2all.dbl_common_rows/LouvainAnnot.ldaOut.count_mat.H3K4me1.match_dbl.K-30.RData")
inf.annot.dbl <- file.path(hubprefix, "jyeung/data/scChiC/raw_data_spikeins/H3K4me1_H3K9me3_analysis/first_try/clustering_outputs.mouse_spikein_BMround2all.dbl_common_rows/LouvainAnnot.ldaOut.count_mat.H3K4me1xH3K9me3.match_dbl.K-30.RData")
...
load(inf.annot.k9me3, v=T)
dat.annot.k9me3 <- dat.merge
load(inf.annot.k4me1, v=T)
dat.annot.k4me1 <- dat.merge

load(inf.annot.dbl, v=T)
dat.annot.dbl <- dat.merge
...
dat.umap.k9me3 <- left_join(dat.umaps.lst[["H3K9me3"]], subset(dat.annot.k9me3, select = c(cell, cluster))) %>%
  left_join(., coords.dbl.annots) %>%
  rowwise()  %>%
  mutate(cluster = ifelse(is.na(cluster), louv.repress, cluster))
...
m <- ggplot(dat.umap.k9me3, aes(x = umap1, y = umap2, color = louv.repress)) + 
  ggtitle("H3K9me3") + 
  geom_point() + 
  theme_bw() + 
  scale_color_manual(values = cbPalette, na.value = "grey85") + 
...
dat.var.dbl <- subset(dat.annot.dbl, select = c(cell, cell.var.within.sum.norm))

m.grid <- ggplot(coords.dbl.annots %>% left_join(., dat.var.dbl), aes(x = louv.act, y = louv.repress, color = cell.var.within.sum.norm)) + 
  geom_point(alpha = 0.25, position = position_jitternormal(sd_x = 0.08, sd_y = 0.08)) + 
  theme_bw() + 
  theme(aspect.ratio=0.6) + 
  # scale_color_manual(values = cbPalette) + 
