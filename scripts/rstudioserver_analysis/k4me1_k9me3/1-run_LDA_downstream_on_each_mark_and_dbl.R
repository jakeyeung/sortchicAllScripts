...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/k4me1_k9me3/1-run_LDA_downstream_on_each_mark_and_dbl.R
# Use this to determine topics which will be used 
...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/H3K4me1_H3K9me3_LDA_downstream"
dir.create(outdir)
...
inmain <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/raw_demultiplexed/LDA_outputs_all_spikeins/ldaAnalysisBins_mouse_spikein_BMround2all.dbl_common_rows")
# load(inf.lda, v=T)

# jsuffix <- ".varfilt_1.5.K-30"
jsuffix <- "match_dbl.K-30"
