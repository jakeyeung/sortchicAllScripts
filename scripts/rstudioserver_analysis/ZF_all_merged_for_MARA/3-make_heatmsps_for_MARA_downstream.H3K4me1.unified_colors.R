...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/ZF_all_merged_for_MARA/3-make_heatmsps_for_MARA_downstream.H3K4me1.unified_colors.R
# description
rm(list=ls())
...
# add more motifs
# jmotifs <- c("Gata1", "Gfi1", "Ets1", "Runx1", "Rorc", "Bptf", "Egr1", "Otx2", "Zbtb16", "Mbd2", "Mecp2", "Tfdp1", jmotifs)
