...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/ZF_all_merged_for_MARA/2-check_mouse_BM_glmpca_H3K4me1_H3K27me3_together.R
# 
...
jmarks <- c("H3K4me1", "H3K27me3"); names(jmarks) <- jmarks
...
outpdf <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/GLMPCA_peaks_primetime/H3K4me1_and_H3K27me3_glmpca_peaks_primetime.", Sys.Date(), ".pdf")
...
for (jmark in jmarks){
  outtxt <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/GLMPCA_peaks_primetime/H3K4me1_and_H3K27me3_glmpca_peaks_primetime.", Sys.Date(), ".", jmark, ".txt")
  print(jmark)
