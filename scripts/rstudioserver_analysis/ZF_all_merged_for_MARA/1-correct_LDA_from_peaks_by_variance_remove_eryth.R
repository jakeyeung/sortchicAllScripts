...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/ZF_all_merged_for_MARA/1-correct_LDA_from_peaks_by_variance_remove_eryth.R
# description
...
jdate <- "2020-04-29"
jsuffix <- "ZF_AllMerged.imputevarfilt.lessstringent.LDAfromPeaks.remove_eryth"
...
inmain.peaks <- paste0(hubprefix, "/jyeung/data/zebrafish_scchic/LDA_outputs/ldaAnalysisBins_ZFWKM_peaks_remove_eryth")
...
jout <- mclapply(jmarks, function(jmark){
  ...
  infname.peaks <- paste0("lda_outputs.", jmark, ".imputevarfilt.lessstringent.mapq_40.countTable.HiddenDomains.NewCountFilters.remove_eryth.K-30.binarize.FALSE/ldaOut.", jmark, ".imputevarfilt.lessstringent.mapq_40.countTable.HiddenDomains.NewCountFilters.remove_eryth.K-30.Robj")
