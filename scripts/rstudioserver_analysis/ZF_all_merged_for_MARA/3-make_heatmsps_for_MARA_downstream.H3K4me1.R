...
if (make.plots){
  outpdf <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/from_rstudioserver/pdfs_all/MARA_output_BM/heatmap_MARA_outputs.", jmark, ".pdf")
...
hm.out <- heatmap3(jsub, margins = c(5, 8), cexCol = 0.35, cexRow = 0.35, Colv = TRUE, Rowv = NA, 
...
hm.out <- heatmap3(t(jsub), margins = c(5, 8), cexCol = 0.35, cexRow = 0.35, lasRow = 2, 
                   Colv = NA, Rowv = TRUE, 
                   # ColSideColors = rep("blue", ncol(jsub)), 
