...
outf.mat <- file.path(hubprefix, paste0("jyeung/data/scChiC/mara_analysis_ZF-AllMerged2_Peaks_1000/", jmark, "/mara_input/sitecount_mats/hiddenDomains_motevo_merged.closest.long.scale_0.center_0.byrow_0.", jmark, ".RemoveLargePeaks.txt"))
outf.mat.colscaled <- file.path(hubprefix, paste0("jyeung/data/scChiC/mara_analysis_ZF-AllMerged2_Peaks_1000/", jmark, "/mara_input/sitecount_mats/hiddenDomains_motevo_merged.closest.long.scale_0.center_0.byrow_0.", jmark, ".RemoveLargePeaks.ColumnScaled.txt"))
outf.mat.rowscaled <- file.path(hubprefix, paste0("jyeung/data/scChiC/mara_analysis_ZF-AllMerged2_Peaks_1000/", jmark, "/mara_input/sitecount_mats/hiddenDomains_motevo_merged.closest.long.scale_0.center_0.byrow_0.", jmark, ".RemoveLargePeaks.RowScaled.txt"))

outpdf <- file.path(hubprefix, paste0("jyeung/data/scChiC/mara_analysis_ZF-AllMerged2_Peaks_1000/", jmark, "/mara_input/sitecount_mats/hiddenDomains_motevo_merged.closest.long.scale_0.center_0.byrow_0.", jmark, ".RemoveLargePeaks.pdf"))
...
outf.exprs <- file.path(hubprefix, paste0("jyeung/data/scChiC/mara_analysis_ZF-AllMerged2_Peaks_1000/", jmark, "/mara_input/count_mats_peaks_from_GLMPCA/ZF_", jmark, ".ZF_AllMerged.VarCorrection.Poisson.GLMPCA.RemoveLargePeaks.txt"))
...
print(paste("Xline:", xline))

if (xline < 4){
  print("xline < 4, setting to 4")
  xline <- 4
}
