...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/BM_all_merged/2-explore_Giladi_et_al_get_marker_genes_filter_celltypes.Downsampled.EightCtypes.R
# 
...
jmeth <- "poisson"
WithVpreb <- FALSE
outrds <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/public_data/Giladi_et_al_2018/diff_exprs_Giladi_seurat.celltypes_filt.meth_", jmeth, ".Downsampled.EightCtypes.WithVpreb_", WithVpreb, ".", Sys.Date(), ".rds")
outpdf <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/scChiC/public_data/Giladi_et_al_2018/diff_exprs_Giladi_seurat.celltypes_filt..meth_", jmeth, ".Downsampled.EightCtypes.WithVpreb_", WithVpreb, ".", Sys.Date(), ".pdf")
