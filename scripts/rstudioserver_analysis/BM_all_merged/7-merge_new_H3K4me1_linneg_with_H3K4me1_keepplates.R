...
# inf.mat.orig <- "/home/jyeung/hpc/scChiC/from_rstudioserver/quality_control_postLDA_var_BM.keepPlates/BM_H3K4me1.varcutoff_0.3.platesRemoved.rds"
inf.mat.orig <- "/home/jyeung/hpc/scChiC/from_rstudioserver/quality_control_postLDA_var_BM.keepPlates/BM_H3K4me1.varcutoff_0.3.platesRemoved.rds"
# bnameout <- strsplit(basename(inf.mat.orig), ".rds")[[1]][[1]]
bnameout <- "BM_H3K4me1.varcutoff_0.3.keepplates"
