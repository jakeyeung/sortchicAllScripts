...
outdir <- paste0("/home/jyeung/hpc/scChiC/from_rstudioserver/glmpca_analyses/GLMPCA_outputs.", jsuffix)  # write to pdf dir
pdfdir <- paste0("/home/jyeung/hpc/scChiC/from_rstudioserver/glmpca_analyses/GLMPCA_outputs.", jsuffix, ".downstream")  # write to pdf dir
dir.create(pdfdir)
