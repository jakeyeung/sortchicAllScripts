...
outname <- paste0("BM_", jmark, ".varcutoff_", jcutoff.ncuts.var, ".KeepAllPlates.RemoveTopic7.rds")
pdfname <- paste0("BM_", jmark, ".varcutoff_", jcutoff.ncuts.var, ".KeepAllPlates.Removetopic7.pdf")
