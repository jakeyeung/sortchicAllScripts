...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/databases/gene_tss/giladi_filtered.seurat.downsampled"
dir.create(outdir)
...
outf <- file.path(outdir, paste0("gene_tss_winsize.", winsize, ".", jbase, ".pval_", pvalmax, ".logfc_", logfc.min, ".", jsign, ".meth_", jmeth, ".downsampled.bed"))
