...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/BM_all_merged/8-downstream_LDA_varfilt_topics_celltypes_unenriched_KeepBestPlates.final.R
# description
...
jsuffix <- "KeepBestPlates.final"

jdate <- "2020-02-06"
ldadate <- "2020-02-06"
inmain <- "/home/jyeung/hpc/scChiC/raw_demultiplexed/LDA_outputs_all/ldaAnalysisBins_B6BM_All_allmarks.2020-02-06.var_filt.UnenrichedAndAllMerged.KeepBestPlates"

jconds <- c("Unenriched", "AllMerged")
jmarks <- c("H3K4me1", "H3K4me3", "H3K27me3", "H3K9me3"); names(jmarks) <- jmarks

outdir <- paste0("/home/jyeung/hpc/scChiC/from_rstudioserver/pdfs_all/BM_LDA_downstream_topics_celltypes_Giladi.UnenrichedAllMerged.", jsuffix)
dir.create(outdir)
