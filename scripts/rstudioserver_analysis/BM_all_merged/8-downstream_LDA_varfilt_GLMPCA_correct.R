...
jmark <- "H3K4me1"
topn <- 150
outname <- paste0("PZ_", jmark, ".GLMPCA_var_correction.", topn, ".", Sys.Date(), ".nbins_", binskeep, ".RData")
...
glm.inits <- InitGLMPCAfromLDA(count.mat, tm.result, dat.merge2, covar.cname = "ncuts.var", bins.keep = binskeep, do.log = FALSE, svd.on.Yinit = TRUE, use.orig.sz = TRUE)
