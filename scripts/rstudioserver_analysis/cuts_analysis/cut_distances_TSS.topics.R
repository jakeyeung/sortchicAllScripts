...
ntopics <- "1000"
indir.geneset <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/from_rstudioserver/bedannotations/MouseBMFromTopics.", ntopics)
outdir <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/WKM_BM_merged/pdfs_from_WKM_BM_merged/cut_distances_topic_top_", ntopics, "_BM")
dir.create(outdir)
