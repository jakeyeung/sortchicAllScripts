...
for (jmark in jmarks){
  ...
  infmain <- file.path(hubprefix, paste0("jyeung/data/scChiC/cut_distances_all_clusters2.rerun.bedfile_Topics_winsize_", jwinsize, ".", jtopn, ".withraw.fourCtypes"))
  assertthat::assert_that(dir.exists(infmain))
  outdir <- file.path(hubprefix, paste0("jyeung/data/scChiC/from_rstudioserver/pdfs_all/cut_distances.genesets.winsize_", jwinsize, ".", jtopn, ".withraw.fourCtypes"))
  dir.create(outdir)
