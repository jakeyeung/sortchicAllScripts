...
# topic 2 failed
# jtopics <- paste("topic", c(27, 1, 30, 6, 8, 17, 22, 26, 29, 9, 2), sep = "")
# names(jtopics) <- c("InnateLymph", "Eryth-Slc7a6-", "LinnegCore", "Eryth-Sox6-", "LinnegIsland", "Eryth-Gfi1-", "Neutrophils", "LinnegCore2", "LinnegIsland2", "HSCs-Tead1-", "HSCs-Vwa5b1-")

# cleaner add vtopic 16 bcels
jtopics <- paste("topic", c(27, 1, 30, 6, 8, 17, 22, 26, 29, 9, 16), sep = "")
names(jtopics) <- c("InnateLymph", "Eryth-Slc7a6-", "LinnegCore", "Eryth-Sox6-", "LinnegIsland", "Eryth-Gfi1-", "Neutrophils", "LinnegCore2", "LinnegIsland2", "HSCs-Tead1-", "Bcells")
...
mm.celltype.lst <- FitMixtureModelLabelCells(tm.result$topics, jtopics, jthres = 0.5, show.plots = TRUE, dat.umap.long = dat.umap.lda, quantile.if.fail = 0.98, fail.if.nfrac = jfail.if.nfrac)
