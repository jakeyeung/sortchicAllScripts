...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/BM_all_merged_GLMPCAcorrected_downstream/2-summarize_GLMPCA_UMAPs.H3K9me3.R
# 
...
jtopics <- paste("topic", c(10, 27, 3, 25), sep = "")
names(jtopics) <- c("Eryth", "Dendritic", "Bcells", "Neutrophils")
...
write.plots <- TRUE
cbPalette <- c("#696969", "#E69F00", "#56B4E9", "#ff9f7d", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#006400", "#FFB6C1",  "#32CD32", "#009E73", "#eb9d01", "#7fbedf", "#0b1b7f")

jthres.frac.cells <- 0.8  # threshold for imputing NAs to celltype 
