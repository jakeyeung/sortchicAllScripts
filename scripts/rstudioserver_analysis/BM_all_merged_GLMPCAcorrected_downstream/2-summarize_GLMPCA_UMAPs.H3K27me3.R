...
jtopics <- paste("topic", c(10, 14, 18, 12, 27, 30), sep = "")
names(jtopics) <- c("Eryth", "InnateLymph", "Dendritic", "Bcells1", "Bcells2", "Neutrophils")
names(jtopics) <- paste(names(jtopics), jtopics, sep = "_")
# names.final <- c("InnateLymph", "Eryth", "Dendritic", "Neutrophils", "Bcells", "Bcells")
