...
jtopics <- paste("topic", c(17, 11, 6, 27, 23, 4), sep = "")
names(jtopics) <- c("InnateLymph", "Eryth", "Dendritic", "Neutrophils", "Bcells", "Bcells2")
...
write.plots <- TRUE
cbPalette <- c("#696969", "#E69F00", "#56B4E9", "#0b1b7f", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#006400", "#FFB6C1", "#32CD32", "#009E73", "#ff9f7d", "#eb9d01", "#7fbedf")
