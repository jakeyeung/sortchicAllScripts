...
indir <- file.path(jprefix, "data/zebrafish_scchic/LDA_outputs/ldaAnalysisBins_ZF_AllMerged.winsize_50000")
outdir <- file.path(jprefix, "data/scChiC/from_rstudioserver/LDA_downstream_ZF.2020-04-11")
dir.create(outdir)

outrdata <- file.path(outdir, "dat_across_marks_outputs.2020-04-11.RData")
