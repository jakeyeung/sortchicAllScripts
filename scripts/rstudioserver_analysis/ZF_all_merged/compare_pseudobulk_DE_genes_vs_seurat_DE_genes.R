...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/ZF_all_merged/compare_pseudobulk_DE_genes_vs_seurat_DE_genes.R
# Seurat has some universal bias towards HSCs is this real? 
...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/zebrafish_scchic/from_rstudio/pseudobulk_analysis_all/pseudobulk_analysis.downsample.compare_de_genes.WithMerged2"
dir.create(outdir)
