...
outf <- paste0("/home/jyeung/hub_oudenaarden/jyeung/data/zebrafish_scchic/from_rstudio/rdata_robjs/WKM_pseudobulk_scrnaseq_downsampled.", Sys.Date(), ".EosinophilsKeep.AllGenes.RData")
...
mat.pbulk.ds.filt <- mat.pbulk.ds
mat.pbulk.ds.ctypefilt.filt <- mat.pbulk.ds.ctypefilt
