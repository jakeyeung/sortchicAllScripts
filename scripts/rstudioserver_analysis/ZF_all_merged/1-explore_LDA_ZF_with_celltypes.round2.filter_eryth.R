...
# keepn <- 250
keepnvec <- c(150)
cbPalette <- c("#696969", "#E69F00", "#56B4E9", "#009E73", "#F0E442", "#0072B2", "#D55E00", "#CC79A7", "#006400", "#FFB6C1", "#32C  D32", "#0b1b7f", "#ff9f7d", "#eb9d01", "#7fbedf")
...
jsuffix <- ".remove_eryth"
indir <- file.path(jprefix, paste0("data/zebrafish_scchic/LDA_outputs/ldaAnalysisBins_ZF_AllMerged.winsize_", jwin, jsuffix))
outdir <- file.path(jprefix, paste0("data/zebrafish_scchic/from_rstudio/LDA_downstream/LDA_downstream_ZF.", Sys.Date(), jsuffix))
dir.create(outdir)
