...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/ZF_all_merged/8-finalize_plot_2D_distributions_fit_thresholds.R
# 
...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/zebrafish_scchic/from_rstudio/pseudobulk_analysis_all/pseudobulk_analysis.integrated_analysis.TSS.plot_2D_distributions.NoLymph.OtherWinsizes"
dir.create(outdir)
outname <- paste0("WKM_2D_active_vs_repressed_fit_thresholds.NoLymph.", Sys.Date(), ".winsize_", jwinsize, ".pdf")
...
jdate <- "2020-05-09"
indir <- "/home/jyeung/hub_oudenaarden/jyeung/data/zebrafish_scchic/from_rstudio/pseudobulk_analysis_all/pseudobulk_analysis.integrated_analysis.TSS.readsDS.likeBM.NoLymph.OtherWinsizes"
inprefix <- paste0("integrated_analysis.", jdate, ".UseTSSfromH3K4me3.DSreads_", downsample.reads, ".DScells_", downsample.cells, ".likeBM.NoLymph.winsize_", jwinsize)
