...
outdir <- paste0("/home/jyeung/data/from_rstudioserver/zebrafish.", jtest, ".SameNbrCells2.", Sys.Date())  # run over night
dir.create(outdir)

outf <- file.path(outdir, paste0("WKM_pseudobulk_scrnaseq_downsampled.", Sys.Date(), ".SameNbrCells.RData"))
outrds <- file.path(outdir, paste0("diff_exprs_Chloe_seurat.full.SameNbrCells.rds"))
outrds.ctypefilt <- file.path(outdir, paste0("diff_exprs_Chloe_seurat.full.ctypefilt.SameNbrCells.rds"))
