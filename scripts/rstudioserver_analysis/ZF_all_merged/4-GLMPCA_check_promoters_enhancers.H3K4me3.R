...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/ZF_all_merged/4-GLMPCA_check_promoters_enhancers.R
# make PDF and tables useful for bigwigs 
...
jtopics.lst <- list("monocytes" = c("topic10"),
                    "eryth" = c("topic14"),
                    "lymph" = c("topic4", "topic18"),
                    "HSCs" = c("topic29"))

# name louvains to a celltype
louv2ctype <- hash("louvain1" = "monocyte",
                   "louvain2" = "Unknown",
                   "louvain3" = "lymph",
                   "louvain4" = "HSC",
                   "louvain5" = "eryth")
