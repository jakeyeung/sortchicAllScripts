...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/ZF_all_merged/8-finalize_downsampled_TSS_counts_integrated_all_3_marks_readsDownsampled.R
# description
...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/zebrafish_scchic/from_rstudio/pseudobulk_analysis_all/pseudobulk_analysis.integrated_analysis.TSS.readsDS"
dir.create(outdir)

outname <- paste0("integrated_analysis.", Sys.Date(), ".UseTSSfromH3K4me3.downsamplereads_", downsample.reads, ".pdf")
outname.rdata <- paste0("integrated_analysis.", Sys.Date(), ".UseTSSfromH3K4me3.readsDS.downsamplereads_", downsample.reads, ".RData")
