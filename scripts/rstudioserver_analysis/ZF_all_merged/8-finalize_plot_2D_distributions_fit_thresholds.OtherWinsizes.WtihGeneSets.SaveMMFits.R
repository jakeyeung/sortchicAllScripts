...
outname.rdata <- paste0("WKM_2D_active_vs_repressed_fit_thresholds.", Sys.Date(), ".winsize_", jwinsize, ".WithGeneSets.RData")
...
if (file.exists(outf.rdata)){
  ...
  save(jlong.thres.lst, dat.mm, file = outf.rdata)
}
