...
# File: ~/projects/scchic/scripts/rstudioserver_analysis/ZF_all_merged/get_DE_genes_like_in_BM.R
# 
...
outdir <- "/home/jyeung/hub_oudenaarden/jyeung/data/zebrafish_scchic/from_rstudio/pseudobulk_analysis_all/pseudobulk_analysis.get_DE_genes_from_pbulk_scrnaseq"
outname <- paste0("de_genes_sorted_and_giladi.WithHouseKeepAndNotExpressed.FixExprsOther.exprsmax_", exprs.max, ".logfcmin_", logfc.min, ".logfcmax_", logfc.max)
