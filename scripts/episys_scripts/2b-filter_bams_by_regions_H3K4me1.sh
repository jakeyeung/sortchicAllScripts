...
outdir="/Users/yeung/data/scchic/for_episys/sorted_bams_filtered_H3K4me1"
...
for clst in $clstrs; do
  ...
  inbam="/Users/yeung/data/scchic/for_episys/sorted_bams_build95/H3K4me1_cluster_${clst}.bam"
