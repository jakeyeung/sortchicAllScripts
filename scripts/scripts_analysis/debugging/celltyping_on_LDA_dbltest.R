...
# File: ~/projects/scchic/scripts/scripts_analysis/debugging/celltyping_on_LDA_dbltest.R
# 
...
inf <- "/Users/yeung/data/dblchic/bonemarrow/from_cluster/LDA_outputs/ldaAnalysisBins_BM_dblmarks/lda_outputs.count_mat.BM-B6-H3K4m1-191202.cutoff_500.cutoffTA_0.25.K-30.binarize.FALSE/ldaOut.count_mat.BM-B6-H3K4m1-191202.cutoff_500.cutoffTA_0.25.K-30.Robj"
...
pdf(paste0("/Users/yeung/data/scchic/pdfs/stemcell_linneg_analysis.redo/", jmark, ".", jsuff, ".celltype_using_topics.dbltest.pdf"), useDingbats = FALSE)
