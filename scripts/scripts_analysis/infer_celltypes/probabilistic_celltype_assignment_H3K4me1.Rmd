...
author: Jake Yeung
path: "~/projects/scchic/scripts/scripts_analysis/revisions/probabilistic_celltype_assignment_H3K4me1.R"
date: 2019-09-14
output:
   html_document:
     toc: true
...
infs <- list.files(indir, pattern = paste0(jmark, ".*.tab"), full.names = TRUE)
