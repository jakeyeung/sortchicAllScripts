...
maradir <- paste0("/Users/yeung/data/scchic/from_cluster/mara_outputs_B6/mara_analysis_cluster_build95_B6_CorrPeakFilt.cells_from_bin_analysis/", jmark, "/mara_output/hiddenDomains_cellmin_0-cellmax_9999999-binarize_TRUE-B6_", jmark, ".filt_0.99.center_TRUE_K50-hiddenDomains_motevo_merged.closest.long.scale_0.center_0.byrow_0.bugfix.filt.0--K", kchoose, "/hiddenDomains_cellmin_0-cellmax_9999999-binarize_TRUE-B6_", jmark, ".filt_0.99.center_TRUE_K", kchoose)
...
PlotXYWithColor(dat.merge %>% filter(motif == "Tal1"), xvar = "umap1", yvar = "umap2", cname = "activity", jcol = scales::muted("darkred"))
PlotXYWithColor(dat.merge %>% filter(motif == "Tal1"), xvar = "umap1", yvar = "umap2", cname = "activity", jcol = scales::muted("darkred"))
...
pdf(paste0("~/data/scchic/pdfs/B6_figures/tf_activities/TF_activities.", jmark, ".K_", kchoose, ".", Sys.Date(), ".pdf"), useDingbats = FALSE)
...
pdf(paste0("~/data/scchic/pdfs/B6_figures/tf_activities/TF_activity_with_gene_exprs.", jmark, ".", Sys.Date(), ".pdf"), useDingbats = FALSE)
