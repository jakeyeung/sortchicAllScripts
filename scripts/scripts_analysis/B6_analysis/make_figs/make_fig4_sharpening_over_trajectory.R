...
# File: ~/projects/scchic/scripts/scripts_analysis/B6_analysis/make_figs/make_fig4_sharpening_over_trajectory.R
# Sharpening over trajectory
...
pdfout <- file.path(outdir, "Fig4_GenomeWide_Variance.pdf")
