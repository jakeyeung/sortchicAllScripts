...
pdf("/Users/yeung/data/scchic/pdfs/B6_figures/stringent_pdfs/variance_over_trajectory_stringent/trajectory_lines_over_pseudotime.pdf", useDingbats = FALSE)
...
for (marks.sub in marks.sub.lst){
  ...
  gifpath <- paste0("/Users/yeung/data/scchic/pdfs/B6_figures/stringent_pdfs/variance_over_trajectory_stringent/sharpening.", Sys.Date(), ".", marks.str, ".stringent.gif")
