...
pdf(paste0("/Users/yeung/data/scchic/pdfs/B6_figures/quality_controls_B6/quality_controls_all_marks_stringent.pcounts.", (1-p), ".pfrac.", (1-pfrac), ".", Sys.Date(), ".pdf"), useDingbats = FALSE)
  print(m.final)
  print(m.hist)
  print(m.hist.all)
dev.off()
