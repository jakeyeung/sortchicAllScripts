...
cells.keep <- count.sum$cell
count.sum.overlapping <- count.sum
...
count.sum <- lapply(infs, ReadCellSum) %>%
  bind_rows()  %>%
  rowwise() %>%
...
# save outputs
save(cells.var.merged2, cells.chromo.mean.wide.mat, dat.mat.global.mean, chromo.constant, cells.var.chromo.within, file = "/Users/yeung/data/scchic/robjs/B6_objs_stringent/variance_decomposed_within_across_stringent.nonoverlapping.RData")

pdf(paste0("/Users/yeung/data/scchic/pdfs/B6_figures/stringent_pdfs/variance_over_trajectory_stringent/decompose_variance.", Sys.Date(), ".stringent.nonoverlapping.pdf"), useDingbats = FALSE)
...
pdf(paste0("/Users/yeung/data/scchic/pdfs/B6_figures/stringent_pdfs/variance_over_trajectory_stringent/variance_over_pseudotime_fewer_trajs.withinvar.", Sys.Date(), ".stringent.pdf"), useDingbats=FALSE)
...
pdf(paste0("/Users/yeung/data/scchic/pdfs/B6_figures/stringent_pdfs/variance_over_trajectory_stringent/cell_counts_over_umap.", Sys.Date(), ".stringent.pdf"), useDingbats=FALSE)
...
save(jfits, jfits.merged, cell.sums.merged.all, file = "/Users/yeung/data/scchic/robjs/fits_cell_sum_along_traj/fits_cell_size_along_traj.nonoverlapping.RData")
save(jfits.var, jfits.merged.var, cells.var.merged2, file = "/Users/yeung/data/scchic/robjs/fits_cell_sum_along_traj/variance_along_traj.nonoverlapping.RData")

# write tables to dropbox
inf1 <- "/Users/yeung/Dropbox/scCHiC_figs/tables/fits_counts_along_traj.nonoverlapping.txt"
inf2 <- "/Users/yeung/Dropbox/scCHiC_figs/tables/fits_merged_counts_along_traj.nonoverlapping.txt"
inf3 <- "/Users/yeung/Dropbox/scCHiC_figs/tables/fits_var_along_traj.nonoverlapping.txt"
inf4 <- "/Users/yeung/Dropbox/scCHiC_figs/tables/fits_merged_var_along_traj.nonoverlapping.txt"
