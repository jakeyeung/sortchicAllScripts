...
# where are eryths?
# inf.outobj <- paste0("/Users/yeung/data/scchic/from_cluster/oud3700/ldaAnalysisBins_PZ-Bl6-BM-StemCells/lda_out_meanfilt.PZ-Bl6-BM-StemCells_", jmark, "_matsMergedNonenriched_2019-09-29.CountThres0.K-30_35_50.OutObjs.RData")
# load(inf.outobj, v=T)
