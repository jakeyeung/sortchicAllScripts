...
meta <- subset(meta, celltype != ctype.exclude)
meta2 <- subset(meta2, celltype != ctype.exclude)
...
outf <- paste0("/Users/yeung/data/scchic/public_data/Zebrafish_WKM/Baron_et_al_pseudobulk_Zebrafish_WKM_nothrombo.", Sys.Date(), ".rds")
