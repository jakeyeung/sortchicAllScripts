...
inf.proj <- paste0("/Users/yeung/data/scchic/from_cluster/ldaAnalysisTSS_ZFbonemarrow.v2/lda_outputs.PZ-ChIC-", jprefix.proj, "-", jmark, 
                   ".winsize_", winsize, ".merged.K-", Kstr, ".binarize.FALSE/ldaOut.PZ-ChIC-", jprefix.proj, "-", jmark, 
...
inf.proj.lda <- paste0("/Users/yeung/data/scchic/from_cluster/ldaAnalysisTSS_ZFbonemarrow.v2/lda_outputs.PZ-ChIC-", jprefix, "-", jmark, 
                       ".winsize_", winsize, ".merged.K-", Kstr, ".binarize.FALSE/projections/ldaOut.PZ-ChIC-", jprefix, "-", jmark, 
                       ".winsize_", winsize, ".merged.K-", Kstr, ".x.PZ-ChIC-", jprefix.proj, "-", jmark, ".winsize_", winsize, ".merged.RData")
