...
# File: ~/projects/scchic/scripts/scripts_analysis/zebrafish/make_tx_dataset_zebrafish_WKM.R
...
outrds <- "/Users/yeung/data/scchic/public_data/Zebrafish_WKM/Baron_et_al_pseudobulk_Zebrafish_WKM.rds"
saveRDS(dat.mat.filt.long, file = outrds)
