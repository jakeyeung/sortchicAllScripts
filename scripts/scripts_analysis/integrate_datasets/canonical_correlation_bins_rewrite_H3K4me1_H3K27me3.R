# Jake Yeung
# Date of Creation: 2019-03-17
# File: ~/projects/scchic/scripts/scripts_analysis/integrate_datasets/canonical_correlation_bins_rewrite_H3K4me1_H3K27me3.R
# One activae one repressive 
...
pdf(paste0("~/Dropbox/scCHiC_figs/FIG4_BM/analyses/2019-03-17_cca_output_", paste(marks.keep, collapse = "-"), "_active_marks.pdf"), useDingbats = FALSE)
