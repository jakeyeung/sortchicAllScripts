...
# File: ~/projects/scchic/scripts/scripts_analysis/primetime/plot_marker_genes_all_4_marks_TFs.R
# Show TFs
...
dir.create(outdir)
fname <- "marker_genes_redo_nofilt_rescale_TFs.pdf"
